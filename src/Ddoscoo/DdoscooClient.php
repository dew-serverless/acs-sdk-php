 ...
 * @method \Http\Promise\Promise describeDomainTopRefererAsync($arguments = [])
 * @method \Dew\Acs\Result describeDomainTopUserAgent(array $arguments = [])
 * @method \Http\Promise\Promise describeDomainTopUserAgentAsync($arguments = [])
 * @method \Dew\Acs\Result describeDomainTopFingerprint(array $arguments = [])
 * @method \Http\Promise\Promise describeDomainTopFingerprintAsync($arguments = [])
 * @method \Dew\Acs\Result describeDomainBps(array $arguments = [])
 * @method \Http\Promise\Promise describeDomainBpsAsync($arguments = [])
 * @method \Dew\Acs\Result describeDomainTopHttpMethod(array $arguments = [])
 * @method \Http\Promise\Promise describeDomainTopHttpMethodAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result configL7GlobalRule(array $arguments = [])
 * @method \Http\Promise\Promise configL7GlobalRuleAsync($arguments = [])
 * @method \Dew\Acs\Result describeL7GlobalRule(array $arguments = [])
 * @method \Http\Promise\Promise describeL7GlobalRuleAsync($arguments = [])
