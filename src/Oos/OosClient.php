 ...
 * @method \Dew\Acs\Result checkGitRepoFileExists(array $arguments = [])
 * @method \Http\Promise\Promise checkGitRepoFileExistsAsync($arguments = [])
 * @method \Dew\Acs\Result listGitOrganizations(array $arguments = [])
 * @method \Http\Promise\Promise listGitOrganizationsAsync($arguments = [])
 * @method \Dew\Acs\Result listGitRepositories(array $arguments = [])
 * @method \Http\Promise\Promise listGitRepositoriesAsync($arguments = [])
 * @method \Dew\Acs\Result listGitBranches(array $arguments = [])
 * @method \Http\Promise\Promise listGitBranchesAsync($arguments = [])
 * @method \Dew\Acs\Result listGitAccounts(array $arguments = [])
 * @method \Http\Promise\Promise listGitAccountsAsync($arguments = [])
 * @method \Dew\Acs\Result createGitRepository(array $arguments = [])
 * @method \Http\Promise\Promise createGitRepositoryAsync($arguments = [])
 * @method \Dew\Acs\Result checkGitRepositoryExists(array $arguments = [])
 * @method \Http\Promise\Promise checkGitRepositoryExistsAsync($arguments = [])
 * @method \Dew\Acs\Result getGitBranch(array $arguments = [])
 * @method \Http\Promise\Promise getGitBranchAsync($arguments = [])
 * @method \Dew\Acs\Result listGitRepositoryContents(array $arguments = [])
 * @method \Http\Promise\Promise listGitRepositoryContentsAsync($arguments = [])
 * @method \Dew\Acs\Result getGitRepository(array $arguments = [])
 * @method \Http\Promise\Promise getGitRepositoryAsync($arguments = [])
 */
