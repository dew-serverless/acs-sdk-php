 ...
 * @method \Dew\Acs\Result putDataLakeCachePrefetchJob(array $arguments = [])
 * @method \Http\Promise\Promise putDataLakeCachePrefetchJobAsync($arguments = [])
 * @method \Dew\Acs\Result startDataLakeCachePrefetchJob(array $arguments = [])
 * @method \Http\Promise\Promise startDataLakeCachePrefetchJobAsync($arguments = [])
 * @method \Dew\Acs\Result listDataLakeStorageTransferJob(array $arguments = [])
 * @method \Http\Promise\Promise listDataLakeStorageTransferJobAsync($arguments = [])
 */
