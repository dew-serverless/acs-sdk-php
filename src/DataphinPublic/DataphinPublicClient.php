...
/**
 * @method \Dew\Acs\Result checkProjectHasDependency(array $arguments = [])
 * @method \Http\Promise\Promise checkProjectHasDependencyAsync($arguments = [])
 * @method \Dew\Acs\Result getProject(array $arguments = [])
 * @method \Http\Promise\Promise getProjectAsync($arguments = [])
 * @method \Dew\Acs\Result getProjectByName(array $arguments = [])
 * @method \Http\Promise\Promise getProjectByNameAsync($arguments = [])
 * @method \Dew\Acs\Result addProjectMember(array $arguments = [])
 * @method \Http\Promise\Promise addProjectMemberAsync($arguments = [])
 * @method \Dew\Acs\Result getProjectWhiteLists(array $arguments = [])
 * @method \Http\Promise\Promise getProjectWhiteListsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result removeProjectMember(array $arguments = [])
 * @method \Http\Promise\Promise removeProjectMemberAsync($arguments = [])
 * @method \Dew\Acs\Result replaceProjectWhiteLists(array $arguments = [])
 * @method \Http\Promise\Promise replaceProjectWhiteListsAsync($arguments = [])
 * @method \Dew\Acs\Result updateProjectMember(array $arguments = [])
 * @method \Http\Promise\Promise updateProjectMemberAsync($arguments = [])
 * @method \Dew\Acs\Result updateTenantComputeEngine(array $arguments = [])
 * @method \Http\Promise\Promise updateTenantComputeEngineAsync($arguments = [])
 * @method \Dew\Acs\Result getDataSourceDependencies(array $arguments = [])
 * @method \Http\Promise\Promise getDataSourceDependenciesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result checkComputeSourceConnectivity(array $arguments = [])
 * @method \Http\Promise\Promise checkComputeSourceConnectivityAsync($arguments = [])
 * @method \Dew\Acs\Result checkComputeSourceConnectivityById(array $arguments = [])
 * @method \Http\Promise\Promise checkComputeSourceConnectivityByIdAsync($arguments = [])
 * @method \Dew\Acs\Result listComputeSources(array $arguments = [])
 * @method \Http\Promise\Promise listComputeSourcesAsync($arguments = [])
 * @method \Dew\Acs\Result updateComputeSource(array $arguments = [])
 * @method \Http\Promise\Promise updateComputeSourceAsync($arguments = [])
 * @method \Dew\Acs\Result getComputeSource(array $arguments = [])
 * @method \Http\Promise\Promise getComputeSourceAsync($arguments = [])
 * @method \Dew\Acs\Result deleteComputeSource(array $arguments = [])
 * @method \Http\Promise\Promise deleteComputeSourceAsync($arguments = [])
 * @method \Dew\Acs\Result createComputeSource(array $arguments = [])
 * @method \Http\Promise\Promise createComputeSourceAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result transferOwnershipForAllObject(array $arguments = [])
 * @method \Http\Promise\Promise transferOwnershipForAllObjectAsync($arguments = [])
 * @method \Dew\Acs\Result retryTransferOwnership(array $arguments = [])
 * @method \Http\Promise\Promise retryTransferOwnershipAsync($arguments = [])
 * @method \Dew\Acs\Result getTransferInfo(array $arguments = [])
 * @method \Http\Promise\Promise getTransferInfoAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deleteRowPermission(array $arguments = [])
 * @method \Http\Promise\Promise deleteRowPermissionAsync($arguments = [])
 * @method \Dew\Acs\Result getAccountByRowPermissionId(array $arguments = [])
 * @method \Http\Promise\Promise getAccountByRowPermissionIdAsync($arguments = [])
 * @method \Dew\Acs\Result listRowPermission(array $arguments = [])
 * @method \Http\Promise\Promise listRowPermissionAsync($arguments = [])
 * @method \Dew\Acs\Result listRowPermissionByUserId(array $arguments = [])
 * @method \Http\Promise\Promise listRowPermissionByUserIdAsync($arguments = [])
 * @method \Dew\Acs\Result updateRowPermission(array $arguments = [])
 * @method \Http\Promise\Promise updateRowPermissionAsync($arguments = [])
 * @method \Dew\Acs\Result createRowPermission(array $arguments = [])
 * @method \Http\Promise\Promise createRowPermissionAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result updatePipelineByAsync(array $arguments = [])
 * @method \Http\Promise\Promise updatePipelineByAsyncAsync($arguments = [])
 * @method \Dew\Acs\Result offlinePipelineByAsync(array $arguments = [])
 * @method \Http\Promise\Promise offlinePipelineByAsyncAsync($arguments = [])
 * @method \Dew\Acs\Result getPipelineById(array $arguments = [])
 * @method \Http\Promise\Promise getPipelineByIdAsync($arguments = [])
 * @method \Dew\Acs\Result offlinePipeline(array $arguments = [])
 * @method \Http\Promise\Promise offlinePipelineAsync($arguments = [])
 * @method \Dew\Acs\Result createPipeline(array $arguments = [])
 * @method \Http\Promise\Promise createPipelineAsync($arguments = [])
 * @method \Dew\Acs\Result getPipelineAsyncResult(array $arguments = [])
 * @method \Http\Promise\Promise getPipelineAsyncResultAsync($arguments = [])
 * @method \Dew\Acs\Result createPipelineByAsync(array $arguments = [])
 * @method \Http\Promise\Promise createPipelineByAsyncAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getStreamJobs(array $arguments = [])
 * @method \Http\Promise\Promise getStreamJobsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getResourceByVersion(array $arguments = [])
 * @method \Http\Promise\Promise getResourceByVersionAsync($arguments = [])
 * @method \Dew\Acs\Result updateResource(array $arguments = [])
 * @method \Http\Promise\Promise updateResourceAsync($arguments = [])
 * @method \Dew\Acs\Result getFileStorageCredential(array $arguments = [])
 * @method \Http\Promise\Promise getFileStorageCredentialAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getUdf(array $arguments = [])
 * @method \Http\Promise\Promise getUdfAsync($arguments = [])
 * @method \Dew\Acs\Result getUdfByVersion(array $arguments = [])
 * @method \Http\Promise\Promise getUdfByVersionAsync($arguments = [])
 * @method \Dew\Acs\Result updateUdf(array $arguments = [])
 * @method \Http\Promise\Promise updateUdfAsync($arguments = [])
 * @method \Dew\Acs\Result deleteUdf(array $arguments = [])
 * @method \Http\Promise\Promise deleteUdfAsync($arguments = [])
 * @method \Dew\Acs\Result createUdf(array $arguments = [])
 * @method \Http\Promise\Promise createUdfAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deleteRegisterLineage(array $arguments = [])
 * @method \Http\Promise\Promise deleteRegisterLineageAsync($arguments = [])
 * @method \Dew\Acs\Result addRegisterLineage(array $arguments = [])
 * @method \Http\Promise\Promise addRegisterLineageAsync($arguments = [])
 * @method \Dew\Acs\Result getTableLineageByTaskId(array $arguments = [])
 * @method \Http\Promise\Promise getTableLineageByTaskIdAsync($arguments = [])
 * @method \Dew\Acs\Result getTableColumnLineageByTaskId(array $arguments = [])
 * @method \Http\Promise\Promise getTableColumnLineageByTaskIdAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result revokeDataServiceApi(array $arguments = [])
 * @method \Http\Promise\Promise revokeDataServiceApiAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listDataServiceMyAppPermissions(array $arguments = [])
 * @method \Http\Promise\Promise listDataServiceMyAppPermissionsAsync($arguments = [])
 * @method \Dew\Acs\Result listDataServiceMyApiPermissions(array $arguments = [])
 * @method \Http\Promise\Promise listDataServiceMyApiPermissionsAsync($arguments = [])
 * @method \Dew\Acs\Result listDataServiceAuthorizedApps(array $arguments = [])
 * @method \Http\Promise\Promise listDataServiceAuthorizedAppsAsync($arguments = [])
 * @method \Dew\Acs\Result listDataServiceApiImpacts(array $arguments = [])
 * @method \Http\Promise\Promise listDataServiceApiImpactsAsync($arguments = [])
 * @method \Dew\Acs\Result listDataServiceApiCalls(array $arguments = [])
 * @method \Http\Promise\Promise listDataServiceApiCallsAsync($arguments = [])
 * @method \Dew\Acs\Result listDataServiceApiCallStatistics(array $arguments = [])
 * @method \Http\Promise\Promise listDataServiceApiCallStatisticsAsync($arguments = [])
 * @method \Dew\Acs\Result grantDataServiceApi(array $arguments = [])
 * @method \Http\Promise\Promise grantDataServiceApiAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceProjectAddableUsers(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceProjectAddableUsersAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceMyProjects(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceMyProjectsAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceAuthorizedProjects(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceAuthorizedProjectsAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceAuthorizedAppsByGroupId(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceAuthorizedAppsByGroupIdAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceAppsByGroupId(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceAppsByGroupIdAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceAppGroups(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceAppGroupsAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceAppAuthorizedUsers(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceAppAuthorizedUsersAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceApiGroups(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceApiGroupsAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceApiErrorImpact(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceApiErrorImpactAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceApiDocument(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceApiDocumentAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceApiCallTrend(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceApiCallTrendAsync($arguments = [])
 * @method \Dew\Acs\Result getDataServiceApiCallSummary(array $arguments = [])
 * @method \Http\Promise\Promise getDataServiceApiCallSummaryAsync($arguments = [])
 * @method \Dew\Acs\Result applyDataServiceApp(array $arguments = [])
 * @method \Http\Promise\Promise applyDataServiceAppAsync($arguments = [])
 * @method \Dew\Acs\Result applyDataServiceApi(array $arguments = [])
 * @method \Http\Promise\Promise applyDataServiceApiAsync($arguments = [])
 * @method \Dew\Acs\Result addDataServiceProjectMember(array $arguments = [])
 * @method \Http\Promise\Promise addDataServiceProjectMemberAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listApiByApp(array $arguments = [])
 * @method \Http\Promise\Promise listApiByAppAsync($arguments = [])
