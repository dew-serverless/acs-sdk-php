 ...
 * @method \Dew\Acs\Result detachGroupPlugin(array $arguments = [])
 * @method \Http\Promise\Promise detachGroupPluginAsync($arguments = [])
 * @method \Dew\Acs\Result attachGroupPlugin(array $arguments = [])
 * @method \Http\Promise\Promise attachGroupPluginAsync($arguments = [])
 * @method \Dew\Acs\Result describePluginsByGroup(array $arguments = [])
 * @method \Http\Promise\Promise describePluginsByGroupAsync($arguments = [])
 * @method \Dew\Acs\Result describePluginGroups(array $arguments = [])
 * @method \Http\Promise\Promise describePluginGroupsAsync($arguments = [])
