...
/**
 * @method \Dew\Acs\Result updateDocumentChunk(array $arguments = [])
 * @method \Http\Promise\Promise updateDocumentChunkAsync($arguments = [])
 ...
 * @method \Http\Promise\Promise runAgentAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result realtimeDialogAssist(array $arguments = [])
 * @method \Http\Promise\Promise realtimeDialogAssistAsync($arguments = [])
 * @method \Dew\Acs\Result getDialogDetail(array $arguments = [])
 * @method \Http\Promise\Promise getDialogDetailAsync($arguments = [])
 * @method \Dew\Acs\Result getDialogLog(array $arguments = [])
 * @method \Http\Promise\Promise getDialogLogAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createDialogAnalysisTask(array $arguments = [])
 * @method \Http\Promise\Promise createDialogAnalysisTaskAsync($arguments = [])
