 ...
 * @method \Dew\Acs\Result listPhysicalConnectionFeatures(array $arguments = [])
 * @method \Http\Promise\Promise listPhysicalConnectionFeaturesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listBusinessRegions(array $arguments = [])
 * @method \Http\Promise\Promise listBusinessRegionsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeGrantRulesToEcr(array $arguments = [])
 * @method \Http\Promise\Promise describeGrantRulesToEcrAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deleteExpressConnect(array $arguments = [])
 * @method \Http\Promise\Promise deleteExpressConnectAsync($arguments = [])
