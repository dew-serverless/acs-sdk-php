 ...
 * @method \Dew\Acs\Result updateExecutors(array $arguments = [])
 * @method \Http\Promise\Promise updateExecutorsAsync($arguments = [])
 * @method \Dew\Acs\Result getExecutorConfig(array $arguments = [])
 * @method \Http\Promise\Promise getExecutorConfigAsync($arguments = [])
 * @method \Dew\Acs\Result createExecutors(array $arguments = [])
 * @method \Http\Promise\Promise createExecutorsAsync($arguments = [])
 * @method \Dew\Acs\Result syncJobs(array $arguments = [])
 * @method \Http\Promise\Promise syncJobsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listK8sResource(array $arguments = [])
 * @method \Http\Promise\Promise listK8sResourceAsync($arguments = [])
