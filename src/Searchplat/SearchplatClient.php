 ...
 * @method \Dew\Acs\Result stopOfflineTask(array $arguments = [])
 * @method \Http\Promise\Promise stopOfflineTaskAsync($arguments = [])
 * @method \Dew\Acs\Result startOfflineTask(array $arguments = [])
 * @method \Http\Promise\Promise startOfflineTaskAsync($arguments = [])
 * @method \Dew\Acs\Result listOfflineTask(array $arguments = [])
 * @method \Http\Promise\Promise listOfflineTaskAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getOfflineTask(array $arguments = [])
 * @method \Http\Promise\Promise getOfflineTaskAsync($arguments = [])
 * @method \Dew\Acs\Result deleteOfflineTask(array $arguments = [])
 * @method \Http\Promise\Promise deleteOfflineTaskAsync($arguments = [])
 * @method \Dew\Acs\Result updateCapability(array $arguments = [])
 * @method \Http\Promise\Promise updateCapabilityAsync($arguments = [])
 * @method \Dew\Acs\Result listCapabilities(array $arguments = [])
 * @method \Http\Promise\Promise listCapabilitiesAsync($arguments = [])
 * @method \Dew\Acs\Result describeCapability(array $arguments = [])
 * @method \Http\Promise\Promise describeCapabilityAsync($arguments = [])
 * @method \Dew\Acs\Result deleteCapability(array $arguments = [])
 * @method \Http\Promise\Promise deleteCapabilityAsync($arguments = [])
 * @method \Dew\Acs\Result createCapability(array $arguments = [])
 * @method \Http\Promise\Promise createCapabilityAsync($arguments = [])
