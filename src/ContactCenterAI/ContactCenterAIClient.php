...
namespace Dew\Acs\ContactCenterAI;

use Dew\Acs\AcsClient;

/**
 * @method \Dew\Acs\Result runCompletion(array $arguments = [])
 * @method \Http\Promise\Promise runCompletionAsync($arguments = [])
 * @method \Dew\Acs\Result runCompletionMessage(array $arguments = [])
