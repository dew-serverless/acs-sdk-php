...
namespace Dew\Acs\FaRui;

use Dew\Acs\AcsClient;

/**
 * @method \Dew\Acs\Result runLegalAdviceConsultation(array $arguments = [])
 * @method \Http\Promise\Promise runLegalAdviceConsultationAsync($arguments = [])
 * @method \Dew\Acs\Result createTextFile(array $arguments = [])
