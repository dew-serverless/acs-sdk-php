...
/**
 * @method \Dew\Acs\Result updateArtifactSubscriptionRule(array $arguments = [])
 * @method \Http\Promise\Promise updateArtifactSubscriptionRuleAsync($arguments = [])
 * @method \Dew\Acs\Result deleteArtifactSubscriptionRule(array $arguments = [])
 * @method \Http\Promise\Promise deleteArtifactSubscriptionRuleAsync($arguments = [])
 * @method \Dew\Acs\Result listArtifactSubscriptionTask(array $arguments = [])
 * @method \Http\Promise\Promise listArtifactSubscriptionTaskAsync($arguments = [])
 * @method \Dew\Acs\Result getArtifactSubscriptionRule(array $arguments = [])
 * @method \Http\Promise\Promise getArtifactSubscriptionRuleAsync($arguments = [])
 * @method \Dew\Acs\Result getArtifactSubscriptionTaskResult(array $arguments = [])
 * @method \Http\Promise\Promise getArtifactSubscriptionTaskResultAsync($arguments = [])
 * @method \Dew\Acs\Result createArtifactSubscriptionRule(array $arguments = [])
 * @method \Http\Promise\Promise createArtifactSubscriptionRuleAsync($arguments = [])
 * @method \Dew\Acs\Result listArtifactSubscriptionRule(array $arguments = [])
 * @method \Http\Promise\Promise listArtifactSubscriptionRuleAsync($arguments = [])
 * @method \Dew\Acs\Result getArtifactSubscriptionTask(array $arguments = [])
 * @method \Http\Promise\Promise getArtifactSubscriptionTaskAsync($arguments = [])
 * @method \Dew\Acs\Result createArtifactSubscriptionTask(array $arguments = [])
 * @method \Http\Promise\Promise createArtifactSubscriptionTaskAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createStorageDomainRoutingRule(array $arguments = [])
 * @method \Http\Promise\Promise createStorageDomainRoutingRuleAsync($arguments = [])
 * @method \Dew\Acs\Result deleteStorageDomainRoutingRule(array $arguments = [])
 * @method \Http\Promise\Promise deleteStorageDomainRoutingRuleAsync($arguments = [])
 * @method \Dew\Acs\Result getStorageDomainRoutingRule(array $arguments = [])
 * @method \Http\Promise\Promise getStorageDomainRoutingRuleAsync($arguments = [])
 * @method \Dew\Acs\Result updateStorageDomainRoutingRule(array $arguments = [])
 * @method \Http\Promise\Promise updateStorageDomainRoutingRuleAsync($arguments = [])
