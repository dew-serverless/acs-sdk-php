...
/**
 * Generated from protobuf message <code>acs.tablestore.table.SSESpecification</code>
 */
class SSESpecification extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dew\Acs\Tablestore\Messages\SSEKeyType::class);
        $this->key_type = $var;
