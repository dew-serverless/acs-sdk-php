 ...
 * @method \Dew\Acs\Result updateInstancePolicy(array $arguments = [])
 * @method \Http\Promise\Promise updateInstancePolicyAsync($arguments = [])
 * @method \Dew\Acs\Result deleteInstancePolicy(array $arguments = [])
 * @method \Http\Promise\Promise deleteInstancePolicyAsync($arguments = [])
 * @method \Dew\Acs\Result checkInstancePolicy(array $arguments = [])
