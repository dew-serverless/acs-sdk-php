 ...
 * @method \Dew\Acs\Result stopCloudBenchTask(array $arguments = [])
 * @method \Http\Promise\Promise stopCloudBenchTaskAsync($arguments = [])
 * @method \Dew\Acs\Result createAdamBenchTask(array $arguments = [])
 * @method \Http\Promise\Promise createAdamBenchTaskAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result syncHDMAliyunResource(array $arguments = [])
 * @method \Http\Promise\Promise syncHDMAliyunResourceAsync($arguments = [])
