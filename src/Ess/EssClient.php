 ...
 * @method \Dew\Acs\Result describeInstanceRefreshes(array $arguments = []) {@since 2022-02-22}
 * @method \Http\Promise\Promise describeInstanceRefreshesAsync($arguments = []) {@since 2022-02-22}
 * @method \Dew\Acs\Result startInstanceRefresh(array $arguments = []) {@since 2022-02-22}
 * @method \Http\Promise\Promise startInstanceRefreshAsync($arguments = []) {@since 2022-02-22}
 * @method \Dew\Acs\Result cancelInstanceRefresh(array $arguments = []) {@since 2022-02-22}
 * @method \Http\Promise\Promise cancelInstanceRefreshAsync($arguments = []) {@since 2022-02-22}
 * @method \Dew\Acs\Result rollbackInstanceRefresh(array $arguments = []) {@since 2022-02-22}
 * @method \Http\Promise\Promise rollbackInstanceRefreshAsync($arguments = []) {@since 2022-02-22}
 * @method \Dew\Acs\Result suspendInstanceRefresh(array $arguments = []) {@since 2022-02-22}
