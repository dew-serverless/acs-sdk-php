 ...
 * @method \Dew\Acs\Result updateNatGatewayNatType(array $arguments = [])
 * @method \Http\Promise\Promise updateNatGatewayNatTypeAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result enableNatGatewayEcsMetric(array $arguments = [])
