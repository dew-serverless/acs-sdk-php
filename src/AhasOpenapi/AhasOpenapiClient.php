 ...
 * @method \Dew\Acs\Result getActivityTask(array $arguments = [])
 * @method \Http\Promise\Promise getActivityTaskAsync($arguments = [])
 * @method \Dew\Acs\Result getLicenseKey(array $arguments = [])
 * @method \Http\Promise\Promise getLicenseKeyAsync($arguments = [])
 * @method \Dew\Acs\Result getUserApplications(array $arguments = [])
 * @method \Http\Promise\Promise getUserApplicationsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result checkExperimentRunnable(array $arguments = [])
 * @method \Http\Promise\Promise checkExperimentRunnableAsync($arguments = [])
 * @method \Dew\Acs\Result createExperiment(array $arguments = [])
 * @method \Http\Promise\Promise createExperimentAsync($arguments = [])
 * @method \Dew\Acs\Result executeExperiment(array $arguments = [])
 * @method \Http\Promise\Promise executeExperimentAsync($arguments = [])
 * @method \Dew\Acs\Result finishExperimentTask(array $arguments = [])
 * @method \Http\Promise\Promise finishExperimentTaskAsync($arguments = [])
 * @method \Dew\Acs\Result getExperimentMeta(array $arguments = [])
 * @method \Http\Promise\Promise getExperimentMetaAsync($arguments = [])
 * @method \Dew\Acs\Result getExperimentTask(array $arguments = [])
 * @method \Http\Promise\Promise getExperimentTaskAsync($arguments = [])
 * @method \Dew\Acs\Result listExperimentMetas(array $arguments = [])
 * @method \Http\Promise\Promise listExperimentMetasAsync($arguments = [])
 * @method \Dew\Acs\Result pushExperimentTask(array $arguments = [])
 * @method \Http\Promise\Promise pushExperimentTaskAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result pageableQueryExperimentTaskByExperimentId(array $arguments = [])
 * @method \Http\Promise\Promise pageableQueryExperimentTaskByExperimentIdAsync($arguments = [])
 * @method \Dew\Acs\Result pageableQueryUserExperiment(array $arguments = [])
 * @method \Http\Promise\Promise pageableQueryUserExperimentAsync($arguments = [])
 * @method \Dew\Acs\Result getUserWorkspace(array $arguments = [])
 * @method \Http\Promise\Promise getUserWorkspaceAsync($arguments = [])
 * @method \Dew\Acs\Result pageableQueryExperimentTaskByClusterId(array $arguments = [])
 * @method \Http\Promise\Promise pageableQueryExperimentTaskByClusterIdAsync($arguments = [])
 * @method \Dew\Acs\Result getUserApplicationGroups(array $arguments = [])
 * @method \Http\Promise\Promise getUserApplicationGroupsAsync($arguments = [])
 */
