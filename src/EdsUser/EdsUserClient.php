 ...
 * @method \Dew\Acs\Result moveUserOrg(array $arguments = [])
 * @method \Http\Promise\Promise moveUserOrgAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result userBatchQuitGroup(array $arguments = [])
 * @method \Http\Promise\Promise userBatchQuitGroupAsync($arguments = [])
 * @method \Dew\Acs\Result userBatchJoinGroup(array $arguments = [])
 * @method \Http\Promise\Promise userBatchJoinGroupAsync($arguments = [])
 * @method \Dew\Acs\Result removeGroup(array $arguments = [])
 * @method \Http\Promise\Promise removeGroupAsync($arguments = [])
 * @method \Dew\Acs\Result modifyGroup(array $arguments = [])
 * @method \Http\Promise\Promise modifyGroupAsync($arguments = [])
 * @method \Dew\Acs\Result describeGroupUser(array $arguments = [])
 * @method \Http\Promise\Promise describeGroupUserAsync($arguments = [])
