 ...
 * @method \Dew\Acs\Result listExperiment(array $arguments = [])
 * @method \Http\Promise\Promise listExperimentAsync($arguments = [])
 * @method \Dew\Acs\Result deleteExperiment(array $arguments = [])
 * @method \Http\Promise\Promise deleteExperimentAsync($arguments = [])
 * @method \Dew\Acs\Result setExperimentLabels(array $arguments = [])
 * @method \Http\Promise\Promise setExperimentLabelsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteExperimentLabel(array $arguments = [])
 * @method \Http\Promise\Promise deleteExperimentLabelAsync($arguments = [])
 * @method \Dew\Acs\Result createRun(array $arguments = [])
 * @method \Http\Promise\Promise createRunAsync($arguments = [])
 * @method \Dew\Acs\Result updateRun(array $arguments = [])
 * @method \Http\Promise\Promise updateRunAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deleteRunLabel(array $arguments = [])
 * @method \Http\Promise\Promise deleteRunLabelAsync($arguments = [])
 * @method \Dew\Acs\Result logRunMetrics(array $arguments = [])
 * @method \Http\Promise\Promise logRunMetricsAsync($arguments = [])
 * @method \Dew\Acs\Result listRunMetrics(array $arguments = [])
 * @method \Http\Promise\Promise listRunMetricsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result updateConfigs(array $arguments = [])
 * @method \Http\Promise\Promise updateConfigsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getDatasetFileMetasStatistics(array $arguments = [])
 * @method \Http\Promise\Promise getDatasetFileMetasStatisticsAsync($arguments = [])
 * @method \Dew\Acs\Result stopDatasetJob(array $arguments = [])
 * @method \Http\Promise\Promise stopDatasetJobAsync($arguments = [])
 * @method \Dew\Acs\Result getDatasetJob(array $arguments = [])
 * @method \Http\Promise\Promise getDatasetJobAsync($arguments = [])
 * @method \Dew\Acs\Result createDatasetFileMetas(array $arguments = [])
 * @method \Http\Promise\Promise createDatasetFileMetasAsync($arguments = [])
 * @method \Dew\Acs\Result updateDatasetJob(array $arguments = [])
 * @method \Http\Promise\Promise updateDatasetJobAsync($arguments = [])
 * @method \Dew\Acs\Result listDatasetJobs(array $arguments = [])
 * @method \Http\Promise\Promise listDatasetJobsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDatasetJobConfig(array $arguments = [])
 * @method \Http\Promise\Promise deleteDatasetJobConfigAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDatasetJob(array $arguments = [])
 * @method \Http\Promise\Promise deleteDatasetJobAsync($arguments = [])
 * @method \Dew\Acs\Result updateDatasetJobConfig(array $arguments = [])
 * @method \Http\Promise\Promise updateDatasetJobConfigAsync($arguments = [])
 * @method \Dew\Acs\Result updateDatasetFileMetas(array $arguments = [])
 * @method \Http\Promise\Promise updateDatasetFileMetasAsync($arguments = [])
 * @method \Dew\Acs\Result listDatasetJobConfigs(array $arguments = [])
 * @method \Http\Promise\Promise listDatasetJobConfigsAsync($arguments = [])
 * @method \Dew\Acs\Result listDatasetFileMetas(array $arguments = [])
 * @method \Http\Promise\Promise listDatasetFileMetasAsync($arguments = [])
 * @method \Dew\Acs\Result getDatasetJobConfig(array $arguments = [])
 * @method \Http\Promise\Promise getDatasetJobConfigAsync($arguments = [])
 * @method \Dew\Acs\Result getDatasetFileMeta(array $arguments = [])
 * @method \Http\Promise\Promise getDatasetFileMetaAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDatasetFileMetas(array $arguments = [])
 * @method \Http\Promise\Promise deleteDatasetFileMetasAsync($arguments = [])
 * @method \Dew\Acs\Result createDatasetJobConfig(array $arguments = [])
 * @method \Http\Promise\Promise createDatasetJobConfigAsync($arguments = [])
 * @method \Dew\Acs\Result createDatasetJob(array $arguments = [])
 * @method \Http\Promise\Promise createDatasetJobAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createDatasetVersion(array $arguments = [])
 * @method \Http\Promise\Promise createDatasetVersionAsync($arguments = [])
 * @method \Dew\Acs\Result getDatasetVersion(array $arguments = [])
 * @method \Http\Promise\Promise getDatasetVersionAsync($arguments = [])
 * @method \Dew\Acs\Result listDatasetVersions(array $arguments = [])
 * @method \Http\Promise\Promise listDatasetVersionsAsync($arguments = [])
 * @method \Dew\Acs\Result updateDatasetVersion(array $arguments = [])
 * @method \Http\Promise\Promise updateDatasetVersionAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDatasetVersion(array $arguments = [])
 * @method \Http\Promise\Promise deleteDatasetVersionAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDatasetVersionLabels(array $arguments = [])
 * @method \Http\Promise\Promise deleteDatasetVersionLabelsAsync($arguments = [])
 * @method \Dew\Acs\Result createDatasetVersionLabels(array $arguments = [])
 * @method \Http\Promise\Promise createDatasetVersionLabelsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result setUserConfigs(array $arguments = [])
 * @method \Http\Promise\Promise setUserConfigsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteUserConfig(array $arguments = [])
 * @method \Http\Promise\Promise deleteUserConfigAsync($arguments = [])
 * @method \Dew\Acs\Result listUserConfigs(array $arguments = [])
 * @method \Http\Promise\Promise listUserConfigsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result acceptDataworksEvent(array $arguments = [])
