...
/**
 * Generated from protobuf message <code>acs.tablestore.row.ReturnContent</code>
 */
class ReturnContent extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>optional .acs.tablestore.row.ReturnType return_type = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Dew\Acs\Tablestore\Messages\ReturnType::class);
