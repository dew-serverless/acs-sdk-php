 ...
 * @method \Dew\Acs\Result getPushRule(array $arguments = [])
 * @method \Http\Promise\Promise getPushRuleAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result releaseWorkspace(array $arguments = [])
 * @method \Http\Promise\Promise releaseWorkspaceAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result frozenWorkspace(array $arguments = [])
 * @method \Http\Promise\Promise frozenWorkspaceAsync($arguments = [])
