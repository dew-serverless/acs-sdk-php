 ...
 * @method \Dew\Acs\Result createSchedulerxNotificationPolicy(array $arguments = [])
 * @method \Http\Promise\Promise createSchedulerxNotificationPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result deleteSchedulerxNotificationPolicy(array $arguments = [])
 * @method \Http\Promise\Promise deleteSchedulerxNotificationPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result manageSchedulerxNotificationPolicy(array $arguments = [])
 * @method \Http\Promise\Promise manageSchedulerxNotificationPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result readSchedulerxNotificationPolicy(array $arguments = [])
 * @method \Http\Promise\Promise readSchedulerxNotificationPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result createSchedulerxCalendar(array $arguments = [])
 * @method \Http\Promise\Promise createSchedulerxCalendarAsync($arguments = [])
 * @method \Dew\Acs\Result deleteSchedulerxCalendar(array $arguments = [])
 * @method \Http\Promise\Promise deleteSchedulerxCalendarAsync($arguments = [])
 * @method \Dew\Acs\Result manageSchedulerxCalendar(array $arguments = [])
 * @method \Http\Promise\Promise manageSchedulerxCalendarAsync($arguments = [])
 * @method \Dew\Acs\Result readSchedulerxCalendar(array $arguments = [])
 * @method \Http\Promise\Promise readSchedulerxCalendarAsync($arguments = [])
