 ...
 * @method \Dew\Acs\Result createVsc(array $arguments = [])
 * @method \Http\Promise\Promise createVscAsync($arguments = [])
 * @method \Dew\Acs\Result describeVsc(array $arguments = [])
 * @method \Http\Promise\Promise describeVscAsync($arguments = [])
 * @method \Dew\Acs\Result deleteVsc(array $arguments = [])
 * @method \Http\Promise\Promise deleteVscAsync($arguments = [])
 * @method \Dew\Acs\Result listVscs(array $arguments = [])
 * @method \Http\Promise\Promise listVscsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeDiagnosticResult(array $arguments = [])
 * @method \Http\Promise\Promise describeDiagnosticResultAsync($arguments = [])
