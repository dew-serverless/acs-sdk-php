 ...
 * @method \Dew\Acs\Result createCheckPolicy(array $arguments = [])
 * @method \Http\Promise\Promise createCheckPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result createCheckItem(array $arguments = [])
 * @method \Http\Promise\Promise createCheckItemAsync($arguments = [])
 * @method \Dew\Acs\Result deleteCheckItem(array $arguments = [])
 * @method \Http\Promise\Promise deleteCheckItemAsync($arguments = [])
 * @method \Dew\Acs\Result listCheckItems(array $arguments = [])
 * @method \Http\Promise\Promise listCheckItemsAsync($arguments = [])
 * @method \Dew\Acs\Result updateCheckPolicy(array $arguments = [])
 * @method \Http\Promise\Promise updateCheckPolicyAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listCheckPolicies(array $arguments = [])
 * @method \Http\Promise\Promise listCheckPoliciesAsync($arguments = [])
 * @method \Dew\Acs\Result updateCheckItem(array $arguments = [])
 * @method \Http\Promise\Promise updateCheckItemAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result updateAttackPathWhitelist(array $arguments = [])
 * @method \Http\Promise\Promise updateAttackPathWhitelistAsync($arguments = [])
 * @method \Dew\Acs\Result deleteAttackPathWhitelist(array $arguments = [])
 * @method \Http\Promise\Promise deleteAttackPathWhitelistAsync($arguments = [])
 * @method \Dew\Acs\Result deleteAttackPathSensitiveAssetConfig(array $arguments = [])
 * @method \Http\Promise\Promise deleteAttackPathSensitiveAssetConfigAsync($arguments = [])
 * @method \Dew\Acs\Result listSupportAttackPathAsset(array $arguments = [])
 * @method \Http\Promise\Promise listSupportAttackPathAssetAsync($arguments = [])
 * @method \Dew\Acs\Result getAttackPathWhitelist(array $arguments = [])
 * @method \Http\Promise\Promise getAttackPathWhitelistAsync($arguments = [])
 * @method \Dew\Acs\Result listAttackPathWhitelist(array $arguments = [])
 * @method \Http\Promise\Promise listAttackPathWhitelistAsync($arguments = [])
 * @method \Dew\Acs\Result createAttackPathWhitelist(array $arguments = [])
 * @method \Http\Promise\Promise createAttackPathWhitelistAsync($arguments = [])
 * @method \Dew\Acs\Result createAttackPathSensitiveAssetConfig(array $arguments = [])
 * @method \Http\Promise\Promise createAttackPathSensitiveAssetConfigAsync($arguments = [])
 * @method \Dew\Acs\Result updateAttackPathSensitiveAssetConfig(array $arguments = [])
 * @method \Http\Promise\Promise updateAttackPathSensitiveAssetConfigAsync($arguments = [])
 * @method \Dew\Acs\Result getAttackPathSensitiveAssetConfig(array $arguments = [])
 * @method \Http\Promise\Promise getAttackPathSensitiveAssetConfigAsync($arguments = [])
 * @method \Dew\Acs\Result listAvailableAttackPath(array $arguments = [])
 * @method \Http\Promise\Promise listAvailableAttackPathAsync($arguments = [])
 * @method \Dew\Acs\Result getAttackPathEventDetail(array $arguments = [])
 * @method \Http\Promise\Promise getAttackPathEventDetailAsync($arguments = [])
 * @method \Dew\Acs\Result listAttackPathEvent(array $arguments = [])
 * @method \Http\Promise\Promise listAttackPathEventAsync($arguments = [])
 * @method \Dew\Acs\Result getAttackPathEventStatistics(array $arguments = [])
 ...
 * @method \Dew\Acs\Result installAegisForLingjun(array $arguments = [])
 * @method \Http\Promise\Promise installAegisForLingjunAsync($arguments = [])
 * @method \Dew\Acs\Result listAegisForLingjunStatus(array $arguments = [])
 * @method \Http\Promise\Promise listAegisForLingjunStatusAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeCustomizedDict(array $arguments = [])
 * @method \Http\Promise\Promise describeCustomizedDictAsync($arguments = [])
 * @method \Dew\Acs\Result listUniBackupRecord(array $arguments = [])
 * @method \Http\Promise\Promise listUniBackupRecordAsync($arguments = [])
 * @method \Dew\Acs\Result handleSimilarMaliciousFiles(array $arguments = [])
 * @method \Http\Promise\Promise handleSimilarMaliciousFilesAsync($arguments = [])
 * @method \Dew\Acs\Result generateClusterScannerWebhookYaml(array $arguments = [])
 * @method \Http\Promise\Promise generateClusterScannerWebhookYamlAsync($arguments = [])
 * @method \Dew\Acs\Result describeClusterScannerList(array $arguments = [])
 * @method \Http\Promise\Promise describeClusterScannerListAsync($arguments = [])
 * @method \Dew\Acs\Result getClusterScannerYaml(array $arguments = [])
 * @method \Http\Promise\Promise getClusterScannerYamlAsync($arguments = [])
 * @method \Dew\Acs\Result getAgentlessTaskUsedSizeEstimate(array $arguments = [])
 * @method \Http\Promise\Promise getAgentlessTaskUsedSizeEstimateAsync($arguments = [])
 * @method \Dew\Acs\Result listCloudAssetMatchOperators(array $arguments = [])
 * @method \Http\Promise\Promise listCloudAssetMatchOperatorsAsync($arguments = [])
 * @method \Dew\Acs\Result listCloudAssetSchemas(array $arguments = [])
