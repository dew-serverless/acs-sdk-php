 ...
 * @method \Dew\Acs\Result getResourceGroupRequest(array $arguments = [])
 * @method \Http\Promise\Promise getResourceGroupRequestAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getNodeMetrics(array $arguments = [])
 * @method \Http\Promise\Promise getNodeMetricsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getUserViewMetrics(array $arguments = [])
 * @method \Http\Promise\Promise getUserViewMetricsAsync($arguments = [])
