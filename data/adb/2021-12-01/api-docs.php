<?php return [
            ...
            'SparkBatchSQL' => [
                ...
                'properties' => [
                    ...
                    'Statements' => [
                        'type' => 'array',
                        'items' => [
                            '$ref' => '#/components/schemas/SparkBatchSQLStatement',
                        ],
                    ],
                    'ErrMessage' => [
                        'type' => 'string',
    ...
    'apis' => [
        ...
        'DescribePerformanceViewAttribute' => [
            'methods' => [
                'post',
                'get',
            ],
        ...
        'DescribeCompactionServiceSwitch' => [
            'methods' => [
                'post',
                'get',
            ],
        ...
        'DescribeSparkSQLDiagnosisAttribute' => [
            'methods' => [
                'post',
                'get',
            ],
        ...
        'ExecuteSparkWarehouseBatchSQL' => [
            ...
            'parameters' => [
                ...
                [
                    'name' => 'ExecuteTimeLimitInSeconds',
                    'in' => 'formData',
                    'schema' => [
                        'type' => 'integer',
                        'format' => 'int64',
        ...
        'DeleteMaterializedViewRecommend' => [
            'methods' => [
                'post',
                'get',
            ],
        ...
        'ModifyMaterializedViewRecommend' => [
            'methods' => [
                'get',
                'post',
            ],
        ...
        'CreateMaterializedViewRecommend' => [
            'methods' => [
                'post',
                'get',
            ],
