 ...
 * @method \Dew\Acs\Result describeQueryExplain(array $arguments = [])
 * @method \Http\Promise\Promise describeQueryExplainAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeSecurityIPGroup(array $arguments = [])
 * @method \Http\Promise\Promise describeSecurityIPGroupAsync($arguments = [])
 * @method \Dew\Acs\Result describeSecurityIPGroupRelation(array $arguments = [])
 * @method \Http\Promise\Promise describeSecurityIPGroupRelationAsync($arguments = [])
 * @method \Dew\Acs\Result modifySecurityIPGroup(array $arguments = [])
 * @method \Http\Promise\Promise modifySecurityIPGroupAsync($arguments = [])
 * @method \Dew\Acs\Result modifySecurityIPGroupRelation(array $arguments = [])
 * @method \Http\Promise\Promise modifySecurityIPGroupRelationAsync($arguments = [])
