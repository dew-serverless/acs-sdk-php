 ...
 * @method \Dew\Acs\Result describeDrives(array $arguments = [])
 * @method \Http\Promise\Promise describeDrivesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeCloudDiskGroupDrives(array $arguments = [])
 * @method \Http\Promise\Promise describeCloudDiskGroupDrivesAsync($arguments = [])
 * @method \Dew\Acs\Result describeCloudDiskGroups(array $arguments = [])
 * @method \Http\Promise\Promise describeCloudDiskGroupsAsync($arguments = [])
 * @method \Dew\Acs\Result createCloudDriveGroup(array $arguments = [])
 * @method \Http\Promise\Promise createCloudDriveGroupAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listTransferFiles(array $arguments = [])
 * @method \Http\Promise\Promise listTransferFilesAsync($arguments = [])
 * @method \Dew\Acs\Result transferTaskApprovalCallback(array $arguments = [])
 * @method \Http\Promise\Promise transferTaskApprovalCallbackAsync($arguments = [])
 * @method \Dew\Acs\Result listInstalledApps(array $arguments = [])
 * @method \Http\Promise\Promise listInstalledAppsAsync($arguments = [])
 * @method \Dew\Acs\Result describeEcdReportTasks(array $arguments = [])
