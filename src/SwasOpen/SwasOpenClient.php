 ...
 * @method \Dew\Acs\Result addCustomImageShareAccount(array $arguments = [])
 * @method \Http\Promise\Promise addCustomImageShareAccountAsync($arguments = [])
 * @method \Dew\Acs\Result listCustomImageShareAccounts(array $arguments = [])
 * @method \Http\Promise\Promise listCustomImageShareAccountsAsync($arguments = [])
 * @method \Dew\Acs\Result removeCustomImageShareAccount(array $arguments = [])
 * @method \Http\Promise\Promise removeCustomImageShareAccountAsync($arguments = [])
