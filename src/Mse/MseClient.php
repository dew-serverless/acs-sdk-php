 ...
 * @method \Dew\Acs\Result createPluginConfig(array $arguments = [])
 * @method \Http\Promise\Promise createPluginConfigAsync($arguments = [])
 * @method \Dew\Acs\Result updatePluginConfig(array $arguments = [])
 * @method \Http\Promise\Promise updatePluginConfigAsync($arguments = [])
 * @method \Dew\Acs\Result deletePluginConfig(array $arguments = [])
 * @method \Http\Promise\Promise deletePluginConfigAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result gatewayBlackWhiteList(array $arguments = [])
 * @method \Http\Promise\Promise gatewayBlackWhiteListAsync($arguments = [])
 * @method \Dew\Acs\Result getBlackWhiteList(array $arguments = []) {@deprecated 2019-05-31}
 * @method \Http\Promise\Promise getBlackWhiteListAsync($arguments = []) {@deprecated 2019-05-31}
 ...
 * @method \Dew\Acs\Result getGatewayConfig(array $arguments = [])
 * @method \Http\Promise\Promise getGatewayConfigAsync($arguments = [])
 * @method \Dew\Acs\Result enableProxyProtocol(array $arguments = [])
 * @method \Http\Promise\Promise enableProxyProtocolAsync($arguments = [])
 * @method \Dew\Acs\Result enableHttp2(array $arguments = [])
 * @method \Http\Promise\Promise enableHttp2Async($arguments = [])
 * @method \Dew\Acs\Result preserveHeaderFormat(array $arguments = [])
 * @method \Http\Promise\Promise preserveHeaderFormatAsync($arguments = [])
