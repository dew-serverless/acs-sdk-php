 ...
 * @method \Dew\Acs\Result listSwimmingLaneGatewayRoutes(array $arguments = [])
 * @method \Http\Promise\Promise listSwimmingLaneGatewayRoutesAsync($arguments = [])
 * @method \Dew\Acs\Result listSwimmingLaneGroupTags(array $arguments = [])
 * @method \Http\Promise\Promise listSwimmingLaneGroupTagsAsync($arguments = [])
 * @method \Dew\Acs\Result describeSwimmingLane(array $arguments = [])
 * @method \Http\Promise\Promise describeSwimmingLaneAsync($arguments = [])
 * @method \Dew\Acs\Result listAllSwimmingLanes(array $arguments = [])
 * @method \Http\Promise\Promise listAllSwimmingLanesAsync($arguments = [])
 * @method \Dew\Acs\Result listAllSwimmingLaneGroups(array $arguments = [])
 * @method \Http\Promise\Promise listAllSwimmingLaneGroupsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result updateSwimmingLaneEnableAttribute(array $arguments = [])
 * @method \Http\Promise\Promise updateSwimmingLaneEnableAttributeAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result queryArmsEnable(array $arguments = [])
