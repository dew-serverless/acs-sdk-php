 ...
 * @method \Dew\Acs\Result describeScoreList(array $arguments = [])
 * @method \Http\Promise\Promise describeScoreListAsync($arguments = [])
 * @method \Dew\Acs\Result describeServiceCodeName(array $arguments = [])
 * @method \Http\Promise\Promise describeServiceCodeNameAsync($arguments = [])
 * @method \Dew\Acs\Result pocCreateTask(array $arguments = [])
 * @method \Http\Promise\Promise pocCreateTaskAsync($arguments = [])
 * @method \Dew\Acs\Result pocGetToken(array $arguments = [])
 * @method \Http\Promise\Promise pocGetTokenAsync($arguments = [])
 * @method \Dew\Acs\Result pocSendData(array $arguments = [])
 * @method \Http\Promise\Promise pocSendDataAsync($arguments = [])
 * @method \Dew\Acs\Result describeModelDetailsById(array $arguments = [])
 * @method \Http\Promise\Promise describeModelDetailsByIdAsync($arguments = [])
 * @method \Dew\Acs\Result createModel(array $arguments = [])
 * @method \Http\Promise\Promise createModelAsync($arguments = [])
 * @method \Dew\Acs\Result modelNameIsDuplication(array $arguments = [])
 * @method \Http\Promise\Promise modelNameIsDuplicationAsync($arguments = [])
 * @method \Dew\Acs\Result modelIsUsing(array $arguments = [])
 * @method \Http\Promise\Promise modelIsUsingAsync($arguments = [])
 * @method \Dew\Acs\Result modelFileUpload(array $arguments = [])
 * @method \Http\Promise\Promise modelFileUploadAsync($arguments = [])
 * @method \Dew\Acs\Result modelDelete(array $arguments = [])
 * @method \Http\Promise\Promise modelDeleteAsync($arguments = [])
 * @method \Dew\Acs\Result describeListModel(array $arguments = [])
 * @method \Http\Promise\Promise describeListModelAsync($arguments = [])
 * @method \Dew\Acs\Result modelSampleDownload(array $arguments = [])
 * @method \Http\Promise\Promise modelSampleDownloadAsync($arguments = [])
 * @method \Dew\Acs\Result describeModelOssPolicy(array $arguments = [])
 * @method \Http\Promise\Promise describeModelOssPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result pocGetDownloadUrl(array $arguments = [])
 * @method \Http\Promise\Promise pocGetDownloadUrlAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result importField(array $arguments = [])
 * @method \Http\Promise\Promise importFieldAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deleteSampleBatchMeta(array $arguments = [])
 * @method \Http\Promise\Promise deleteSampleBatchMetaAsync($arguments = [])
 * @method \Dew\Acs\Result describeSampleDataByBatchUUidPage(array $arguments = [])
 * @method \Http\Promise\Promise describeSampleDataByBatchUUidPageAsync($arguments = [])
 * @method \Dew\Acs\Result downloadSmapleBatch(array $arguments = [])
 * @method \Http\Promise\Promise downloadSmapleBatchAsync($arguments = [])
 * @method \Dew\Acs\Result describeSampleDataPage(array $arguments = [])
 * @method \Http\Promise\Promise describeSampleDataPageAsync($arguments = [])
 * @method \Dew\Acs\Result describeSamplebatchPage(array $arguments = [])
 * @method \Http\Promise\Promise describeSamplebatchPageAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result uploadFileCheck(array $arguments = [])
 * @method \Http\Promise\Promise uploadFileCheckAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listVariableDefine(array $arguments = [])
