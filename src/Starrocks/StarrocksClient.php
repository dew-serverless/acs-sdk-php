 ...
 * @method \Http\Promise\Promise queryUpgradableVersionsAsync($arguments = [])
 * @method \Dew\Acs\Result modifyNodeNumberPreCheck(array $arguments = [])
 * @method \Http\Promise\Promise modifyNodeNumberPreCheckAsync($arguments = [])
 * @method \Dew\Acs\Result modifyNodeNumber(array $arguments = [])
 * @method \Http\Promise\Promise modifyNodeNumberAsync($arguments = [])
 * @method \Dew\Acs\Result modifyCuPreCheck(array $arguments = [])
 * @method \Http\Promise\Promise modifyCuPreCheckAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDiskPerformanceLevel(array $arguments = [])
 * @method \Http\Promise\Promise modifyDiskPerformanceLevelAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDiskSize(array $arguments = [])
 * @method \Http\Promise\Promise modifyDiskSizeAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDiskNumber(array $arguments = [])
