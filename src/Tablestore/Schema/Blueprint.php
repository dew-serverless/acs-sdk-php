...
use Dew\Acs\Tablestore\Messages\CapacityUnit;
...
final class Blueprint
{
     ...
     * The table columns.
     *
     * @var \Dew\Acs\Tablestore\Schema\Schema[]
     */
    ...
    {
        $this->throughput = (new ReservedThroughput())
            ->setCapacityUnit($this->throughputCu()->setRead($capacityUnit));
    ...
    {
        $this->throughput = (new ReservedThroughput())
            ->setCapacityUnit($this->throughputCu()->setWrite($capacityUnit));
