 ...
 * @method \Dew\Acs\Result changeCdnDomainToDcdn(array $arguments = [])
 * @method \Http\Promise\Promise changeCdnDomainToDcdnAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeCdnMigrateRegisterStatus(array $arguments = [])
 * @method \Http\Promise\Promise describeCdnMigrateRegisterStatusAsync($arguments = [])
 * @method \Dew\Acs\Result cdnMigrateRegister(array $arguments = [])
 * @method \Http\Promise\Promise cdnMigrateRegisterAsync($arguments = [])
