 ...
 * @method \Dew\Acs\Result refreshRenderingInstanceStreaming(array $arguments = [])
 * @method \Http\Promise\Promise refreshRenderingInstanceStreamingAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getRenderingInstanceCommandsStatus(array $arguments = [])
 * @method \Http\Promise\Promise getRenderingInstanceCommandsStatusAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeRenderingInstanceSettings(array $arguments = [])
 * @method \Http\Promise\Promise describeRenderingInstanceSettingsAsync($arguments = [])
 * @method \Dew\Acs\Result updateRenderingInstanceSettings(array $arguments = [])
 * @method \Http\Promise\Promise updateRenderingInstanceSettingsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteRenderingInstanceSettings(array $arguments = [])
 * @method \Http\Promise\Promise deleteRenderingInstanceSettingsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createRenderingProject(array $arguments = [])
 * @method \Http\Promise\Promise createRenderingProjectAsync($arguments = [])
 * @method \Dew\Acs\Result listRenderingProjects(array $arguments = [])
 * @method \Http\Promise\Promise listRenderingProjectsAsync($arguments = [])
 * @method \Dew\Acs\Result updateRenderingProject(array $arguments = [])
 * @method \Http\Promise\Promise updateRenderingProjectAsync($arguments = [])
 * @method \Dew\Acs\Result associateRenderingProjectInstances(array $arguments = [])
 * @method \Http\Promise\Promise associateRenderingProjectInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result listRenderingProjectInstances(array $arguments = [])
 * @method \Http\Promise\Promise listRenderingProjectInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result getRenderingProjectInstanceStateMetrics(array $arguments = [])
 * @method \Http\Promise\Promise getRenderingProjectInstanceStateMetricsAsync($arguments = [])
 * @method \Dew\Acs\Result disassociateRenderingProjectInstances(array $arguments = [])
 * @method \Http\Promise\Promise disassociateRenderingProjectInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteRenderingProject(array $arguments = [])
 * @method \Http\Promise\Promise deleteRenderingProjectAsync($arguments = [])
 * @method \Dew\Acs\Result startRenderingSession(array $arguments = [])
 * @method \Http\Promise\Promise startRenderingSessionAsync($arguments = [])
 * @method \Dew\Acs\Result listRenderingSessions(array $arguments = [])
 * @method \Http\Promise\Promise listRenderingSessionsAsync($arguments = [])
 * @method \Dew\Acs\Result describeRenderingSession(array $arguments = [])
 * @method \Http\Promise\Promise describeRenderingSessionAsync($arguments = [])
 * @method \Dew\Acs\Result stopRenderingSession(array $arguments = [])
 * @method \Http\Promise\Promise stopRenderingSessionAsync($arguments = [])
