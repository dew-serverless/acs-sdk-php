 ...
 * @method \Dew\Acs\Result modifyDBInstanceProxyConfiguration(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBInstanceProxyConfigurationAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBInstanceConnectionMode(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBInstanceConnectionModeAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeDBInstancesForClone(array $arguments = [])
 * @method \Http\Promise\Promise describeDBInstancesForCloneAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result switchGuardToMasterInstance(array $arguments = [])
 * @method \Http\Promise\Promise switchGuardToMasterInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result cancelImport(array $arguments = [])
 * @method \Http\Promise\Promise cancelImportAsync($arguments = [])
