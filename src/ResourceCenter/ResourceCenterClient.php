 ...
 * @method \Dew\Acs\Result getMultiAccountResourceCounts(array $arguments = [])
 * @method \Http\Promise\Promise getMultiAccountResourceCountsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise createDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise deleteDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result getDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise getDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result getDeliveryChannelStatistics(array $arguments = [])
 * @method \Http\Promise\Promise getDeliveryChannelStatisticsAsync($arguments = [])
 * @method \Dew\Acs\Result listDeliveryChannels(array $arguments = [])
 * @method \Http\Promise\Promise listDeliveryChannelsAsync($arguments = [])
 * @method \Dew\Acs\Result updateDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise updateDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result createMultiAccountDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise createMultiAccountDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result deleteMultiAccountDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise deleteMultiAccountDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result getMultiAccountDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise getMultiAccountDeliveryChannelAsync($arguments = [])
 * @method \Dew\Acs\Result getMultiAccountDeliveryChannelStatistics(array $arguments = [])
 * @method \Http\Promise\Promise getMultiAccountDeliveryChannelStatisticsAsync($arguments = [])
 * @method \Dew\Acs\Result listMultiAccountDeliveryChannels(array $arguments = [])
 * @method \Http\Promise\Promise listMultiAccountDeliveryChannelsAsync($arguments = [])
 * @method \Dew\Acs\Result updateMultiAccountDeliveryChannel(array $arguments = [])
 * @method \Http\Promise\Promise updateMultiAccountDeliveryChannelAsync($arguments = [])
