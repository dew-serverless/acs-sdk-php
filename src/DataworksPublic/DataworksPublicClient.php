 ...
 * @method \Dew\Acs\Result umountDirectory(array $arguments = [])
 * @method \Http\Promise\Promise umountDirectoryAsync($arguments = [])
 * @method \Dew\Acs\Result mountDirectory(array $arguments = [])
 * @method \Http\Promise\Promise mountDirectoryAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createDeployment(array $arguments = []) {@since 2024-05-18}
 * @method \Http\Promise\Promise createDeploymentAsync($arguments = []) {@since 2024-05-18}
 * @method \Dew\Acs\Result abolishDeployment(array $arguments = []) {@since 2024-05-18}
 * @method \Http\Promise\Promise abolishDeploymentAsync($arguments = []) {@since 2024-05-18}
 * @method \Dew\Acs\Result execDeploymentStage(array $arguments = []) {@since 2024-05-18}
 * @method \Http\Promise\Promise execDeploymentStageAsync($arguments = []) {@since 2024-05-18}
