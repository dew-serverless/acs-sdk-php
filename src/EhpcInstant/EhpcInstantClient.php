 ...
 * @method \Dew\Acs\Result createPool(array $arguments = [])
 * @method \Http\Promise\Promise createPoolAsync($arguments = [])
 * @method \Dew\Acs\Result updatePool(array $arguments = [])
 * @method \Http\Promise\Promise updatePoolAsync($arguments = [])
 * @method \Dew\Acs\Result getPool(array $arguments = [])
 * @method \Http\Promise\Promise getPoolAsync($arguments = [])
 * @method \Dew\Acs\Result listPools(array $arguments = [])
