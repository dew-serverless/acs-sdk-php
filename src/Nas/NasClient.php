 ...
 * @method \Dew\Acs\Result setFilesetQuota(array $arguments = [])
 * @method \Http\Promise\Promise setFilesetQuotaAsync($arguments = [])
 * @method \Dew\Acs\Result cancelFilesetQuota(array $arguments = [])
 * @method \Http\Promise\Promise cancelFilesetQuotaAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createLDAPConfig(array $arguments = []) {@deprecated 2017-06-26}
 * @method \Http\Promise\Promise createLDAPConfigAsync($arguments = []) {@deprecated 2017-06-26}
 * @method \Dew\Acs\Result deleteLDAPConfig(array $arguments = []) {@deprecated 2017-06-26}
 * @method \Http\Promise\Promise deleteLDAPConfigAsync($arguments = []) {@deprecated 2017-06-26}
 * @method \Dew\Acs\Result modifyLDAPConfig(array $arguments = []) {@deprecated 2017-06-26}
 * @method \Http\Promise\Promise modifyLDAPConfigAsync($arguments = []) {@deprecated 2017-06-26}
