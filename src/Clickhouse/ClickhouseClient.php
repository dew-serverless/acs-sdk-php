 ...
 * @method \Dew\Acs\Result describeSlowLogTrend(array $arguments = [])
 * @method \Http\Promise\Promise describeSlowLogTrendAsync($arguments = [])
 * @method \Dew\Acs\Result createSLB(array $arguments = [])
 * @method \Http\Promise\Promise createSLBAsync($arguments = [])
 * @method \Dew\Acs\Result deleteSLB(array $arguments = [])
 * @method \Http\Promise\Promise deleteSLBAsync($arguments = [])
 * @method \Dew\Acs\Result changeResourceGroup(array $arguments = [])
 * @method \Http\Promise\Promise changeResourceGroupAsync($arguments = [])
 * @method \Dew\Acs\Result cancelRestartInstance(array $arguments = [])
 * @method \Http\Promise\Promise cancelRestartInstanceAsync($arguments = [])
