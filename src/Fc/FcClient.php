 ...
 * @method \Dew\Acs\Result getSession(array $arguments = [])
 * @method \Http\Promise\Promise getSessionAsync($arguments = [])
 * @method \Dew\Acs\Result updateSession(array $arguments = [])
 * @method \Http\Promise\Promise updateSessionAsync($arguments = [])
 * @method \Dew\Acs\Result listSessions(array $arguments = [])
 * @method \Http\Promise\Promise listSessionsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteSession(array $arguments = [])
 * @method \Http\Promise\Promise deleteSessionAsync($arguments = [])
 * @method \Dew\Acs\Result putScalingConfig(array $arguments = [])
 * @method \Http\Promise\Promise putScalingConfigAsync($arguments = [])
 * @method \Dew\Acs\Result deleteScalingConfig(array $arguments = [])
 * @method \Http\Promise\Promise deleteScalingConfigAsync($arguments = [])
 * @method \Dew\Acs\Result getScalingConfig(array $arguments = [])
 * @method \Http\Promise\Promise getScalingConfigAsync($arguments = [])
 * @method \Dew\Acs\Result listScalingConfigs(array $arguments = [])
 * @method \Http\Promise\Promise listScalingConfigsAsync($arguments = [])
 */
