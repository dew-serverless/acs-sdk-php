 ...
 * @method \Dew\Acs\Result describeCloudRecordStatus(array $arguments = [])
 * @method \Http\Promise\Promise describeCloudRecordStatusAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createCloudNotePhrases(array $arguments = [])
 * @method \Http\Promise\Promise createCloudNotePhrasesAsync($arguments = [])
 * @method \Dew\Acs\Result modifyCloudNotePhrases(array $arguments = [])
 * @method \Http\Promise\Promise modifyCloudNotePhrasesAsync($arguments = [])
 * @method \Dew\Acs\Result describeCloudNotePhrases(array $arguments = [])
 * @method \Http\Promise\Promise describeCloudNotePhrasesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteCloudNotePhrases(array $arguments = [])
 * @method \Http\Promise\Promise deleteCloudNotePhrasesAsync($arguments = [])
 * @method \Dew\Acs\Result startCloudNote(array $arguments = [])
 * @method \Http\Promise\Promise startCloudNoteAsync($arguments = [])
 * @method \Dew\Acs\Result stopCloudNote(array $arguments = [])
 * @method \Http\Promise\Promise stopCloudNoteAsync($arguments = [])
 * @method \Dew\Acs\Result describeCloudNotes(array $arguments = [])
 * @method \Http\Promise\Promise describeCloudNotesAsync($arguments = [])
 * @method \Dew\Acs\Result describeAppAgentFunctionStatus(array $arguments = [])
 * @method \Http\Promise\Promise describeAppAgentFunctionStatusAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAppAgentFunctionStatus(array $arguments = [])
 * @method \Http\Promise\Promise modifyAppAgentFunctionStatusAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAppAgentTemplate(array $arguments = [])
 * @method \Http\Promise\Promise modifyAppAgentTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result describeAppAgentTemplates(array $arguments = [])
 * @method \Http\Promise\Promise describeAppAgentTemplatesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteAppAgentTemplate(array $arguments = [])
 * @method \Http\Promise\Promise deleteAppAgentTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result createAppAgentTemplate(array $arguments = [])
 * @method \Http\Promise\Promise createAppAgentTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result startAgent(array $arguments = [])
 * @method \Http\Promise\Promise startAgentAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result notifyAgent(array $arguments = [])
 * @method \Http\Promise\Promise notifyAgentAsync($arguments = [])
 * @method \Dew\Acs\Result stopAgent(array $arguments = [])
 * @method \Http\Promise\Promise stopAgentAsync($arguments = [])
 * @method \Dew\Acs\Result describeAppViewStatus(array $arguments = [])
 * @method \Http\Promise\Promise describeAppViewStatusAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAppViewStatus(array $arguments = [])
 * @method \Http\Promise\Promise modifyAppViewStatusAsync($arguments = [])
 * @method \Dew\Acs\Result createAppViewTemplate(array $arguments = [])
 * @method \Http\Promise\Promise createAppViewTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAppViewTemplate(array $arguments = [])
 * @method \Http\Promise\Promise modifyAppViewTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result describeAppViewTemplates(array $arguments = [])
 * @method \Http\Promise\Promise describeAppViewTemplatesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteAppViewTemplate(array $arguments = [])
 * @method \Http\Promise\Promise deleteAppViewTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result rtcSipInviteMember(array $arguments = [])
 * @method \Http\Promise\Promise rtcSipInviteMemberAsync($arguments = [])
 * @method \Dew\Acs\Result rtcCancelSipInvite(array $arguments = [])
 * @method \Http\Promise\Promise rtcCancelSipInviteAsync($arguments = [])
 * @method \Dew\Acs\Result startView(array $arguments = [])
 * @method \Http\Promise\Promise startViewAsync($arguments = [])
 * @method \Dew\Acs\Result stopView(array $arguments = [])
 * @method \Http\Promise\Promise stopViewAsync($arguments = [])
 * @method \Dew\Acs\Result rtcSipMute(array $arguments = [])
 * @method \Http\Promise\Promise rtcSipMuteAsync($arguments = [])
 * @method \Dew\Acs\Result modifyViewLayout(array $arguments = [])
 * @method \Http\Promise\Promise modifyViewLayoutAsync($arguments = [])
 * @method \Dew\Acs\Result modifyStreamingProperty(array $arguments = [])
 * @method \Http\Promise\Promise modifyStreamingPropertyAsync($arguments = [])
