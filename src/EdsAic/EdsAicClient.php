 ...
 * @method \Dew\Acs\Result startInstanceAdb(array $arguments = [])
 * @method \Http\Promise\Promise startInstanceAdbAsync($arguments = [])
 * @method \Dew\Acs\Result stopInstanceAdb(array $arguments = [])
 * @method \Http\Promise\Promise stopInstanceAdbAsync($arguments = [])
 * @method \Dew\Acs\Result listInstanceAdbAttributes(array $arguments = [])
 * @method \Http\Promise\Promise listInstanceAdbAttributesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createSystemPropertyTemplate(array $arguments = [])
 * @method \Http\Promise\Promise createSystemPropertyTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result sendSystemPropertyTemplate(array $arguments = [])
 * @method \Http\Promise\Promise sendSystemPropertyTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result describeSystemPropertyTemplates(array $arguments = [])
 * @method \Http\Promise\Promise describeSystemPropertyTemplatesAsync($arguments = [])
 * @method \Dew\Acs\Result getInstanceProperties(array $arguments = [])
 * @method \Http\Promise\Promise getInstancePropertiesAsync($arguments = [])
 * @method \Dew\Acs\Result modifySystemPropertyTemplate(array $arguments = [])
 * @method \Http\Promise\Promise modifySystemPropertyTemplateAsync($arguments = [])
 * @method \Dew\Acs\Result deleteSystemPropertyTemplates(array $arguments = [])
 * @method \Http\Promise\Promise deleteSystemPropertyTemplatesAsync($arguments = [])
 * @method \Dew\Acs\Result describeTasks(array $arguments = [])
 * @method \Http\Promise\Promise describeTasksAsync($arguments = [])
 * @method \Dew\Acs\Result installMonitorAgent(array $arguments = [])
 * @method \Http\Promise\Promise installMonitorAgentAsync($arguments = [])
 * @method \Dew\Acs\Result uninstallMonitorAgent(array $arguments = [])
 * @method \Http\Promise\Promise uninstallMonitorAgentAsync($arguments = [])
