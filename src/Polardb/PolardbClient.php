 ...
 * @method \Dew\Acs\Result describeApplications(array $arguments = [])
 * @method \Http\Promise\Promise describeApplicationsAsync($arguments = [])
 * @method \Dew\Acs\Result createApplication(array $arguments = [])
 * @method \Http\Promise\Promise createApplicationAsync($arguments = [])
 * @method \Dew\Acs\Result describeApplicationAttribute(array $arguments = [])
 * @method \Http\Promise\Promise describeApplicationAttributeAsync($arguments = [])
 * @method \Dew\Acs\Result describeApplicationParameters(array $arguments = [])
 * @method \Http\Promise\Promise describeApplicationParametersAsync($arguments = [])
 * @method \Dew\Acs\Result modifyApplicationParameter(array $arguments = [])
 * @method \Http\Promise\Promise modifyApplicationParameterAsync($arguments = [])
 * @method \Dew\Acs\Result modifyApplicationDescription(array $arguments = [])
 * @method \Http\Promise\Promise modifyApplicationDescriptionAsync($arguments = [])
 * @method \Dew\Acs\Result modifyApplicationWhitelist(array $arguments = [])
 * @method \Http\Promise\Promise modifyApplicationWhitelistAsync($arguments = [])
 * @method \Dew\Acs\Result createApplicationEndpointAddress(array $arguments = [])
 * @method \Http\Promise\Promise createApplicationEndpointAddressAsync($arguments = [])
 * @method \Dew\Acs\Result deleteApplicationEndpointAddress(array $arguments = [])
 * @method \Http\Promise\Promise deleteApplicationEndpointAddressAsync($arguments = [])
 * @method \Dew\Acs\Result attachApplicationPolarFS(array $arguments = [])
 * @method \Http\Promise\Promise attachApplicationPolarFSAsync($arguments = [])
 * @method \Dew\Acs\Result deleteApplication(array $arguments = [])
 * @method \Http\Promise\Promise deleteApplicationAsync($arguments = [])
 * @method \Dew\Acs\Result upgradeDBClusterVersionZonal(array $arguments = [])
 * @method \Http\Promise\Promise upgradeDBClusterVersionZonalAsync($arguments = [])
 * @method \Dew\Acs\Result createAccountZonal(array $arguments = [])
 * @method \Http\Promise\Promise createAccountZonalAsync($arguments = [])
 * @method \Dew\Acs\Result restartDBNodeZonal(array $arguments = [])
 * @method \Http\Promise\Promise restartDBNodeZonalAsync($arguments = [])
 * @method \Dew\Acs\Result describeAccountsZonal(array $arguments = [])
 * @method \Http\Promise\Promise describeAccountsZonalAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDBClusterEndpointZonal(array $arguments = [])
 * @method \Http\Promise\Promise deleteDBClusterEndpointZonalAsync($arguments = [])
 * @method \Dew\Acs\Result createDatabaseZonal(array $arguments = [])
 * @method \Http\Promise\Promise createDatabaseZonalAsync($arguments = [])
 * @method \Dew\Acs\Result grantAccountPrivilegeZonal(array $arguments = [])
 * @method \Http\Promise\Promise grantAccountPrivilegeZonalAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBDescriptionZonal(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBDescriptionZonalAsync($arguments = [])
 * @method \Dew\Acs\Result checkDBNameZonal(array $arguments = [])
 * @method \Http\Promise\Promise checkDBNameZonalAsync($arguments = [])
 * @method \Dew\Acs\Result describeDBClusterVersionZonal(array $arguments = [])
 * @method \Http\Promise\Promise describeDBClusterVersionZonalAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBClusterEndpointZonal(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBClusterEndpointZonalAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAccountPasswordZonal(array $arguments = [])
 * @method \Http\Promise\Promise modifyAccountPasswordZonalAsync($arguments = [])
 * @method \Dew\Acs\Result deleteAccountZonal(array $arguments = [])
 * @method \Http\Promise\Promise deleteAccountZonalAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAccountDescriptionZonal(array $arguments = [])
 * @method \Http\Promise\Promise modifyAccountDescriptionZonalAsync($arguments = [])
 * @method \Dew\Acs\Result resetAccountZonal(array $arguments = [])
 * @method \Http\Promise\Promise resetAccountZonalAsync($arguments = [])
 * @method \Dew\Acs\Result createDBClusterEndpointZonal(array $arguments = [])
 * @method \Http\Promise\Promise createDBClusterEndpointZonalAsync($arguments = [])
 * @method \Dew\Acs\Result revokeAccountPrivilegeZonal(array $arguments = [])
 * @method \Http\Promise\Promise revokeAccountPrivilegeZonalAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBClusterDescriptionZonal(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBClusterDescriptionZonalAsync($arguments = [])
 * @method \Dew\Acs\Result describeDatabasesZonal(array $arguments = [])
 * @method \Http\Promise\Promise describeDatabasesZonalAsync($arguments = [])
 * @method \Dew\Acs\Result describeDBClusterEndpointsZonal(array $arguments = [])
 * @method \Http\Promise\Promise describeDBClusterEndpointsZonalAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDatabaseZonal(array $arguments = [])
 * @method \Http\Promise\Promise deleteDatabaseZonalAsync($arguments = [])
 * @method \Dew\Acs\Result failoverDBClusterZonal(array $arguments = [])
 * @method \Http\Promise\Promise failoverDBClusterZonalAsync($arguments = [])
 * @method \Dew\Acs\Result describeDbClusterAttributeZonal(array $arguments = [])
 * @method \Http\Promise\Promise describeDbClusterAttributeZonalAsync($arguments = [])
 * @method \Dew\Acs\Result checkAccountNameZonal(array $arguments = [])
 * @method \Http\Promise\Promise checkAccountNameZonalAsync($arguments = [])
 * @method \Dew\Acs\Result describeDBClustersZonal(array $arguments = [])
 * @method \Http\Promise\Promise describeDBClustersZonalAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result addPolarFsQuota(array $arguments = [])
 * @method \Http\Promise\Promise addPolarFsQuotaAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result cancelPolarFsFileQuota(array $arguments = [])
 * @method \Http\Promise\Promise cancelPolarFsFileQuotaAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deletePolarFsQuota(array $arguments = [])
 * @method \Http\Promise\Promise deletePolarFsQuotaAsync($arguments = [])
 * @method \Dew\Acs\Result abortDBClusterMigration(array $arguments = [])
 * @method \Http\Promise\Promise abortDBClusterMigrationAsync($arguments = [])
 * @method \Dew\Acs\Result describeApplicationServerlessConf(array $arguments = [])
 * @method \Http\Promise\Promise describeApplicationServerlessConfAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describePolarFsAttribute(array $arguments = [])
 * @method \Http\Promise\Promise describePolarFsAttributeAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describePolarFsQuota(array $arguments = [])
 * @method \Http\Promise\Promise describePolarFsQuotaAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result modifyApplicationServerlessConf(array $arguments = [])
 * @method \Http\Promise\Promise modifyApplicationServerlessConfAsync($arguments = [])
 * @method \Dew\Acs\Result addEncryptionDBRolePrivilege(array $arguments = [])
 * @method \Http\Promise\Promise addEncryptionDBRolePrivilegeAsync($arguments = [])
 * @method \Dew\Acs\Result setPolarFsFileQuota(array $arguments = [])
 * @method \Http\Promise\Promise setPolarFsFileQuotaAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result addFirewallRules(array $arguments = [])
 * @method \Http\Promise\Promise addFirewallRulesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result addSQLRateLimitingRules(array $arguments = [])
 * @method \Http\Promise\Promise addSQLRateLimitingRulesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result cancelCronJobPolicyServerless(array $arguments = [])
 * @method \Http\Promise\Promise cancelCronJobPolicyServerlessAsync($arguments = [])
 * @method \Dew\Acs\Result checkConnectionString(array $arguments = [])
 * @method \Http\Promise\Promise checkConnectionStringAsync($arguments = [])
 * @method \Dew\Acs\Result continueDBClusterMigration(array $arguments = [])
 * @method \Http\Promise\Promise continueDBClusterMigrationAsync($arguments = [])
 * @method \Dew\Acs\Result createCronJobPolicyServerless(array $arguments = [])
 * @method \Http\Promise\Promise createCronJobPolicyServerlessAsync($arguments = [])
 * @method \Dew\Acs\Result createExtensions(array $arguments = [])
 * @method \Http\Promise\Promise createExtensionsAsync($arguments = [])
 * @method \Dew\Acs\Result createNetworkChannel(array $arguments = [])
 * @method \Http\Promise\Promise createNetworkChannelAsync($arguments = [])
 * @method \Dew\Acs\Result deleteAIDBCluster(array $arguments = [])
 * @method \Http\Promise\Promise deleteAIDBClusterAsync($arguments = [])
 * @method \Dew\Acs\Result deleteEncryptionDBRolePrivilege(array $arguments = [])
 * @method \Http\Promise\Promise deleteEncryptionDBRolePrivilegeAsync($arguments = [])
 * @method \Dew\Acs\Result deleteExtensions(array $arguments = [])
 * @method \Http\Promise\Promise deleteExtensionsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteFirewallRules(array $arguments = [])
 * @method \Http\Promise\Promise deleteFirewallRulesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteNetworkChannel(array $arguments = [])
 * @method \Http\Promise\Promise deleteNetworkChannelAsync($arguments = [])
 * @method \Dew\Acs\Result deleteSQLRateLimitingRules(array $arguments = [])
 * @method \Http\Promise\Promise deleteSQLRateLimitingRulesAsync($arguments = [])
 * @method \Dew\Acs\Result describeAIDBClusterAttribute(array $arguments = [])
 * @method \Http\Promise\Promise describeAIDBClusterAttributeAsync($arguments = [])
 * @method \Dew\Acs\Result describeAIDBClusters(array $arguments = [])
 * @method \Http\Promise\Promise describeAIDBClustersAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeColdStorageInstance(array $arguments = [])
 * @method \Http\Promise\Promise describeColdStorageInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result describeCronJobPolicyServerless(array $arguments = [])
 * @method \Http\Promise\Promise describeCronJobPolicyServerlessAsync($arguments = [])
 * @method \Dew\Acs\Result describeCrossCloudLevels(array $arguments = [])
 * @method \Http\Promise\Promise describeCrossCloudLevelsAsync($arguments = [])
 * @method \Dew\Acs\Result describeCrossCloudRegion(array $arguments = [])
 * @method \Http\Promise\Promise describeCrossCloudRegionAsync($arguments = [])
 * @method \Dew\Acs\Result describeCrossCloudRegionMappingToAliyun(array $arguments = [])
 * @method \Http\Promise\Promise describeCrossCloudRegionMappingToAliyunAsync($arguments = [])
 * @method \Dew\Acs\Result describeDBClusterEncryptionKey(array $arguments = [])
 * @method \Http\Promise\Promise describeDBClusterEncryptionKeyAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeDBClusterProxy(array $arguments = [])
 * @method \Http\Promise\Promise describeDBClusterProxyAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeDBLogFiles(array $arguments = [])
 * @method \Http\Promise\Promise describeDBLogFilesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeEncryptionDBRolePrivilege(array $arguments = [])
 * @method \Http\Promise\Promise describeEncryptionDBRolePrivilegeAsync($arguments = [])
 * @method \Dew\Acs\Result describeEncryptionDBSecret(array $arguments = [])
 * @method \Http\Promise\Promise describeEncryptionDBSecretAsync($arguments = [])
 * @method \Dew\Acs\Result describeExtensions(array $arguments = [])
 * @method \Http\Promise\Promise describeExtensionsAsync($arguments = [])
 * @method \Dew\Acs\Result describeFirewallRules(array $arguments = [])
 * @method \Http\Promise\Promise describeFirewallRulesAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeNetworkChannel(array $arguments = [])
 * @method \Http\Promise\Promise describeNetworkChannelAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeResourcePackages(array $arguments = [])
 * @method \Http\Promise\Promise describeResourcePackagesAsync($arguments = [])
 * @method \Dew\Acs\Result describeSQLRateLimitingRules(array $arguments = [])
 * @method \Http\Promise\Promise describeSQLRateLimitingRulesAsync($arguments = [])
 * @method \Dew\Acs\Result describeUpgradeReport(array $arguments = [])
 * @method \Http\Promise\Promise describeUpgradeReportAsync($arguments = [])
 * @method \Dew\Acs\Result describeVSwitchList(array $arguments = [])
 * @method \Http\Promise\Promise describeVSwitchListAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result disableDBClusterOrca(array $arguments = [])
 * @method \Http\Promise\Promise disableDBClusterOrcaAsync($arguments = [])
 * @method \Dew\Acs\Result enableDBClusterOrca(array $arguments = [])
 * @method \Http\Promise\Promise enableDBClusterOrcaAsync($arguments = [])
 * @method \Dew\Acs\Result enableSQLRateLimitingRules(array $arguments = [])
 * @method \Http\Promise\Promise enableSQLRateLimitingRulesAsync($arguments = [])
 * @method \Dew\Acs\Result executeCrossCloudOpenAPI(array $arguments = [])
 * @method \Http\Promise\Promise executeCrossCloudOpenAPIAsync($arguments = [])
 * @method \Dew\Acs\Result generateUpgradeReportForSyncClone(array $arguments = [])
 * @method \Http\Promise\Promise generateUpgradeReportForSyncCloneAsync($arguments = [])
 * @method \Dew\Acs\Result listOrders(array $arguments = [])
 * @method \Http\Promise\Promise listOrdersAsync($arguments = [])
 * @method \Dew\Acs\Result listTagResourcesForRegion(array $arguments = [])
 * @method \Http\Promise\Promise listTagResourcesForRegionAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAIDBClusterDescription(array $arguments = [])
 * @method \Http\Promise\Promise modifyAIDBClusterDescriptionAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAccountLockState(array $arguments = [])
 * @method \Http\Promise\Promise modifyAccountLockStateAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result modifyCronJobPolicyServerless(array $arguments = [])
 * @method \Http\Promise\Promise modifyCronJobPolicyServerlessAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBClusterMigrationEndpoint(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBClusterMigrationEndpointAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBClusterVpc(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBClusterVpcAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBNodeConfig(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBNodeConfigAsync($arguments = [])
 * @method \Dew\Acs\Result modifyDBNodeSccMode(array $arguments = [])
 * @method \Http\Promise\Promise modifyDBNodeSccModeAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result modifyEncryptionDBSecret(array $arguments = [])
 * @method \Http\Promise\Promise modifyEncryptionDBSecretAsync($arguments = [])
 * @method \Dew\Acs\Result modifyFirewallRules(array $arguments = [])
 * @method \Http\Promise\Promise modifyFirewallRulesAsync($arguments = [])
 * @method \Dew\Acs\Result modifyResourcePackage(array $arguments = [])
 * @method \Http\Promise\Promise modifyResourcePackageAsync($arguments = [])
 * @method \Dew\Acs\Result modifySQLRateLimitingRules(array $arguments = [])
 * @method \Http\Promise\Promise modifySQLRateLimitingRulesAsync($arguments = [])
 * @method \Dew\Acs\Result modifyScheduleTask(array $arguments = [])
 * @method \Http\Promise\Promise modifyScheduleTaskAsync($arguments = [])
