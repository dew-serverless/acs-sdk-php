 ...
 * @method \Dew\Acs\Result checkCreateCluster(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise checkCreateClusterAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result createCluster(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise createClusterAsync($arguments = []) {@since 2022-01-01}
 ...
 * @method \Dew\Acs\Result describeCluster(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeClusterAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeClusterStatusSet(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeClusterStatusSetAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result modifyClusterDescription(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise modifyClusterDescriptionAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result deleteCluster(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise deleteClusterAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result upgradeCluster(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise upgradeClusterAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result checkCreateVirtualWareHouse(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise checkCreateVirtualWareHouseAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result createVirtualWareHouse(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise createVirtualWareHouseAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result listVirtualWareHouses(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise listVirtualWareHousesAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result listVirtualWareHouseConfigs(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise listVirtualWareHouseConfigsAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeVirtualWareHouse(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeVirtualWareHouseAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeVirtualWareHouseEndpointInfo(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeVirtualWareHouseEndpointInfoAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeVirtualWareHouseClassSet(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeVirtualWareHouseClassSetAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeVirtualWareHouseStatusSet(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeVirtualWareHouseStatusSetAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result checkModifyVirtualWareHouseResource(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise checkModifyVirtualWareHouseResourceAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result modifyVirtualWareHouseResource(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise modifyVirtualWareHouseResourceAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result restartVirtualWareHouse(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise restartVirtualWareHouseAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result modifyVirtualWareHouseDescription(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise modifyVirtualWareHouseDescriptionAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result modifyVirtualWareHouseConfig(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise modifyVirtualWareHouseConfigAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result allocateVirtualWareHousePublicConnection(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise allocateVirtualWareHousePublicConnectionAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result releaseVirtualWareHousePublicConnection(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise releaseVirtualWareHousePublicConnectionAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result checkDeleteVirtualWareHouse(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise checkDeleteVirtualWareHouseAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result deleteVirtualWareHouse(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise deleteVirtualWareHouseAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeSlowQuery(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeSlowQueryAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeSlowQueryTrend(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeSlowQueryTrendAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeRunningQuery(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeRunningQueryAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result killQuery(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise killQueryAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result getDistributedTablesBufferSize(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise getDistributedTablesBufferSizeAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result listAccounts(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise listAccountsAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeAccount(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeAccountAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result modifyAccountPrivilege(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise modifyAccountPrivilegeAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result describeClusterSecurityInfo(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise describeClusterSecurityInfoAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result patchClusterSecurityIPGroup(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise patchClusterSecurityIPGroupAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result upsertClusterSecurityIPGroup(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise upsertClusterSecurityIPGroupAsync($arguments = []) {@since 2022-01-01}
 * @method \Dew\Acs\Result deleteClusterSecurityIPGroup(array $arguments = []) {@since 2022-01-01}
 * @method \Http\Promise\Promise deleteClusterSecurityIPGroupAsync($arguments = []) {@since 2022-01-01}
