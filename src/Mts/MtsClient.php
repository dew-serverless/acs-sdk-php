 ...
 * @method \Dew\Acs\Result queryCopyrightJob(array $arguments = [])
 * @method \Http\Promise\Promise queryCopyrightJobAsync($arguments = [])
 * @method \Dew\Acs\Result submitTraceAbJob(array $arguments = [])
 * @method \Http\Promise\Promise submitTraceAbJobAsync($arguments = [])
 * @method \Dew\Acs\Result queryTraceAbJob(array $arguments = [])
 * @method \Http\Promise\Promise queryTraceAbJobAsync($arguments = [])
 * @method \Dew\Acs\Result submitTraceM3u8Job(array $arguments = [])
 * @method \Http\Promise\Promise submitTraceM3u8JobAsync($arguments = [])
 * @method \Dew\Acs\Result queryTraceM3u8Job(array $arguments = [])
 * @method \Http\Promise\Promise queryTraceM3u8JobAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result submitImageCopyright(array $arguments = [])
 * @method \Http\Promise\Promise submitImageCopyrightAsync($arguments = [])
 */
