 ...
 * @method \Dew\Acs\Result precheckDuckDBDependency(array $arguments = [])
 * @method \Http\Promise\Promise precheckDuckDBDependencyAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result stopRCInstance(array $arguments = [])
 * @method \Http\Promise\Promise stopRCInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result deleteRCInstances(array $arguments = [])
 * @method \Http\Promise\Promise deleteRCInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result runRCInstances(array $arguments = [])
 * @method \Http\Promise\Promise runRCInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result modifyRCInstanceChargeType(array $arguments = [])
 * @method \Http\Promise\Promise modifyRCInstanceChargeTypeAsync($arguments = [])
 * @method \Dew\Acs\Result startRCInstance(array $arguments = [])
 * @method \Http\Promise\Promise startRCInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result describeRCInstanceAttribute(array $arguments = [])
 * @method \Http\Promise\Promise describeRCInstanceAttributeAsync($arguments = [])
 * @method \Dew\Acs\Result resizeRCInstanceDisk(array $arguments = [])
 * @method \Http\Promise\Promise resizeRCInstanceDiskAsync($arguments = [])
 * @method \Dew\Acs\Result modifyRCInstance(array $arguments = [])
 * @method \Http\Promise\Promise modifyRCInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result deleteRCDeploymentSet(array $arguments = [])
 * @method \Http\Promise\Promise deleteRCDeploymentSetAsync($arguments = [])
 * @method \Dew\Acs\Result describeRCMetricList(array $arguments = [])
 * @method \Http\Promise\Promise describeRCMetricListAsync($arguments = [])
 * @method \Dew\Acs\Result describeRCInstances(array $arguments = [])
 * @method \Http\Promise\Promise describeRCInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result describeRCImageList(array $arguments = [])
 * @method \Http\Promise\Promise describeRCImageListAsync($arguments = [])
 * @method \Dew\Acs\Result modifyRCInstanceDescription(array $arguments = [])
 * @method \Http\Promise\Promise modifyRCInstanceDescriptionAsync($arguments = [])
 * @method \Dew\Acs\Result createRCDisk(array $arguments = [])
 * @method \Http\Promise\Promise createRCDiskAsync($arguments = [])
 * @method \Dew\Acs\Result replaceRCInstanceSystemDisk(array $arguments = [])
 * @method \Http\Promise\Promise replaceRCInstanceSystemDiskAsync($arguments = [])
 * @method \Dew\Acs\Result describeRCInstanceVncUrl(array $arguments = [])
 * @method \Http\Promise\Promise describeRCInstanceVncUrlAsync($arguments = [])
 * @method \Dew\Acs\Result describeRCNodePool(array $arguments = [])
 * @method \Http\Promise\Promise describeRCNodePoolAsync($arguments = [])
 * @method \Dew\Acs\Result createRCNodePool(array $arguments = [])
 * @method \Http\Promise\Promise createRCNodePoolAsync($arguments = [])
 * @method \Dew\Acs\Result renewRCInstance(array $arguments = [])
 * @method \Http\Promise\Promise renewRCInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result authorizeRCSecurityGroupPermission(array $arguments = [])
 * @method \Http\Promise\Promise authorizeRCSecurityGroupPermissionAsync($arguments = [])
