 ...
 * @method \Dew\Acs\Result describeRecursionZone(array $arguments = [])
 * @method \Http\Promise\Promise describeRecursionZoneAsync($arguments = [])
 * @method \Dew\Acs\Result listRecursionZones(array $arguments = [])
 * @method \Http\Promise\Promise listRecursionZonesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteRecursionZone(array $arguments = [])
 * @method \Http\Promise\Promise deleteRecursionZoneAsync($arguments = [])
 * @method \Dew\Acs\Result searchRecursionZones(array $arguments = [])
 * @method \Http\Promise\Promise searchRecursionZonesAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionZoneEffectiveScope(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionZoneEffectiveScopeAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionZoneRemark(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionZoneRemarkAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionZoneProxyPattern(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionZoneProxyPatternAsync($arguments = [])
 * @method \Dew\Acs\Result addRecursionRecord(array $arguments = [])
 * @method \Http\Promise\Promise addRecursionRecordAsync($arguments = [])
 * @method \Dew\Acs\Result describeRecursionRecord(array $arguments = [])
 * @method \Http\Promise\Promise describeRecursionRecordAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionRecord(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionRecordAsync($arguments = [])
 * @method \Dew\Acs\Result listRecursionRecords(array $arguments = [])
 * @method \Http\Promise\Promise listRecursionRecordsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteRecursionRecord(array $arguments = [])
 * @method \Http\Promise\Promise deleteRecursionRecordAsync($arguments = [])
 * @method \Dew\Acs\Result searchRecursionRecords(array $arguments = [])
 * @method \Http\Promise\Promise searchRecursionRecordsAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionRecordEnableStatus(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionRecordEnableStatusAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionRecordWeight(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionRecordWeightAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionRecordWeightEnableStatus(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionRecordWeightEnableStatusAsync($arguments = [])
 * @method \Dew\Acs\Result updateRecursionRecordRemark(array $arguments = [])
 * @method \Http\Promise\Promise updateRecursionRecordRemarkAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result removeRspDomainServerHoldStatusForGateway(array $arguments = [])
