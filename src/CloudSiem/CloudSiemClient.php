 ...
 * @method \Dew\Acs\Result describeCsImportedProdStatusByUser(array $arguments = [])
 * @method \Http\Promise\Promise describeCsImportedProdStatusByUserAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeAttackTimeLine(array $arguments = [])
 * @method \Http\Promise\Promise describeAttackTimeLineAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result doQuickField(array $arguments = [])
 * @method \Http\Promise\Promise doQuickFieldAsync($arguments = [])
 * @method \Dew\Acs\Result listQuickQuery(array $arguments = [])
 * @method \Http\Promise\Promise listQuickQueryAsync($arguments = [])
 * @method \Dew\Acs\Result getQuickQuery(array $arguments = [])
 * @method \Http\Promise\Promise getQuickQueryAsync($arguments = [])
 * @method \Dew\Acs\Result saveQuickQuery(array $arguments = [])
 * @method \Http\Promise\Promise saveQuickQueryAsync($arguments = [])
 * @method \Dew\Acs\Result describeLogStore(array $arguments = [])
 * @method \Http\Promise\Promise describeLogStoreAsync($arguments = [])
 * @method \Dew\Acs\Result showQuickAnalysis(array $arguments = [])
 * @method \Http\Promise\Promise showQuickAnalysisAsync($arguments = [])
