 ...
 * @method \Dew\Acs\Result describeClusterDevices(array $arguments = [])
 * @method \Http\Promise\Promise describeClusterDevicesAsync($arguments = [])
 * @method \Dew\Acs\Result describeClusters(array $arguments = [])
 * @method \Http\Promise\Promise describeClustersAsync($arguments = [])
 * @method \Dew\Acs\Result describeContainerInstanceId(array $arguments = [])
 * @method \Http\Promise\Promise describeContainerInstanceIdAsync($arguments = [])
 * @method \Dew\Acs\Result describeUserDevices(array $arguments = [])
 * @method \Http\Promise\Promise describeUserDevicesAsync($arguments = [])
