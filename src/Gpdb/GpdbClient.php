...
/**
 * @method \Dew\Acs\Result describeModelService(array $arguments = [])
 * @method \Http\Promise\Promise describeModelServiceAsync($arguments = [])
 * @method \Dew\Acs\Result deleteModelService(array $arguments = [])
 * @method \Http\Promise\Promise deleteModelServiceAsync($arguments = [])
 * @method \Dew\Acs\Result listSupportModels(array $arguments = [])
 * @method \Http\Promise\Promise listSupportModelsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result deleteAINode(array $arguments = [])
 * @method \Http\Promise\Promise deleteAINodeAsync($arguments = [])
 * @method \Dew\Acs\Result listAINodePools(array $arguments = [])
 * @method \Http\Promise\Promise listAINodePoolsAsync($arguments = [])
 * @method \Dew\Acs\Result addAINode(array $arguments = [])
 * @method \Http\Promise\Promise addAINodeAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result enableCollectionGraphRAG(array $arguments = [])
 * @method \Http\Promise\Promise enableCollectionGraphRAGAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getGraphRAGJob(array $arguments = [])
 * @method \Http\Promise\Promise getGraphRAGJobAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result createDBInstanceIPArray(array $arguments = [])
 * @method \Http\Promise\Promise createDBInstanceIPArrayAsync($arguments = [])
 * @method \Dew\Acs\Result createDatabase(array $arguments = [])
 * @method \Http\Promise\Promise createDatabaseAsync($arguments = [])
 * @method \Dew\Acs\Result listSlowSQLRecords(array $arguments = [])
 * @method \Http\Promise\Promise listSlowSQLRecordsAsync($arguments = [])
 * @method \Dew\Acs\Result downloadSlowSQLRecords(array $arguments = [])
 * @method \Http\Promise\Promise downloadSlowSQLRecordsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeRebalanceStatus(array $arguments = [])
 * @method \Http\Promise\Promise describeRebalanceStatusAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDBInstanceIPArray(array $arguments = [])
 * @method \Http\Promise\Promise deleteDBInstanceIPArrayAsync($arguments = [])
 * @method \Dew\Acs\Result describeDatabase(array $arguments = [])
 * @method \Http\Promise\Promise describeDatabaseAsync($arguments = [])
 * @method \Dew\Acs\Result describeExtension(array $arguments = [])
 * @method \Http\Promise\Promise describeExtensionAsync($arguments = [])
 * @method \Dew\Acs\Result listDatabaseExtensions(array $arguments = [])
