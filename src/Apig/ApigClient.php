 ...
 * @method \Dew\Acs\Result createMcpServer(array $arguments = [])
 * @method \Http\Promise\Promise createMcpServerAsync($arguments = [])
 * @method \Dew\Acs\Result updateMcpServer(array $arguments = [])
 * @method \Http\Promise\Promise updateMcpServerAsync($arguments = [])
 * @method \Dew\Acs\Result getMcpServer(array $arguments = [])
 * @method \Http\Promise\Promise getMcpServerAsync($arguments = [])
 * @method \Dew\Acs\Result listMcpServers(array $arguments = [])
 * @method \Http\Promise\Promise listMcpServersAsync($arguments = [])
 * @method \Dew\Acs\Result deleteMcpServer(array $arguments = [])
 * @method \Http\Promise\Promise deleteMcpServerAsync($arguments = [])
 * @method \Dew\Acs\Result deployMcpServer(array $arguments = [])
 * @method \Http\Promise\Promise deployMcpServerAsync($arguments = [])
 * @method \Dew\Acs\Result unDeployMcpServer(array $arguments = [])
 * @method \Http\Promise\Promise unDeployMcpServerAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result installPlugin(array $arguments = [])
 * @method \Http\Promise\Promise installPluginAsync($arguments = [])
