 ...
 * @method \Dew\Acs\Result addClientToBlackList(array $arguments = [])
 * @method \Http\Promise\Promise addClientToBlackListAsync($arguments = [])
 * @method \Dew\Acs\Result describeBlackListClients(array $arguments = [])
 * @method \Http\Promise\Promise describeBlackListClientsAsync($arguments = [])
 * @method \Dew\Acs\Result removeClientFromBlackList(array $arguments = [])
 * @method \Http\Promise\Promise removeClientFromBlackListAsync($arguments = [])
