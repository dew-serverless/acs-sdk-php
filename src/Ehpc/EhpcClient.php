 ...
 * @method \Dew\Acs\Result createGWSImage(array $arguments = [])
 * @method \Http\Promise\Promise createGWSImageAsync($arguments = [])
 * @method \Dew\Acs\Result deleteGWSCluster(array $arguments = [])
 * @method \Http\Promise\Promise deleteGWSClusterAsync($arguments = [])
 * @method \Dew\Acs\Result describeGWSImages(array $arguments = [])
 * @method \Http\Promise\Promise describeGWSImagesAsync($arguments = [])
 * @method \Dew\Acs\Result describeGWSClusters(array $arguments = [])
 * @method \Http\Promise\Promise describeGWSClustersAsync($arguments = [])
 * @method \Dew\Acs\Result describeGWSClusterPolicy(array $arguments = [])
 * @method \Http\Promise\Promise describeGWSClusterPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result createGWSCluster(array $arguments = [])
 * @method \Http\Promise\Promise createGWSClusterAsync($arguments = [])
 * @method \Dew\Acs\Result createGWSInstance(array $arguments = [])
 * @method \Http\Promise\Promise createGWSInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result describeGWSInstances(array $arguments = [])
 * @method \Http\Promise\Promise describeGWSInstancesAsync($arguments = [])
 * @method \Dew\Acs\Result deleteGWSInstance(array $arguments = [])
 * @method \Http\Promise\Promise deleteGWSInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result setGWSInstanceUser(array $arguments = [])
 * @method \Http\Promise\Promise setGWSInstanceUserAsync($arguments = [])
 * @method \Dew\Acs\Result setGWSInstanceName(array $arguments = [])
 * @method \Http\Promise\Promise setGWSInstanceNameAsync($arguments = [])
 * @method \Dew\Acs\Result startGWSInstance(array $arguments = [])
 * @method \Http\Promise\Promise startGWSInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result stopGWSInstance(array $arguments = [])
 * @method \Http\Promise\Promise stopGWSInstanceAsync($arguments = [])
 * @method \Dew\Acs\Result mountNFS(array $arguments = [])
 * @method \Http\Promise\Promise mountNFSAsync($arguments = [])
 * @method \Dew\Acs\Result describeNFSClientStatus(array $arguments = [])
 * @method \Http\Promise\Promise describeNFSClientStatusAsync($arguments = [])
 * @method \Dew\Acs\Result setGWSClusterPolicy(array $arguments = [])
 * @method \Http\Promise\Promise setGWSClusterPolicyAsync($arguments = [])
 * @method \Dew\Acs\Result getGWSConnectTicket(array $arguments = [])
 * @method \Http\Promise\Promise getGWSConnectTicketAsync($arguments = [])
