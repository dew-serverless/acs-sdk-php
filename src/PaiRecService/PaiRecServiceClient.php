 ...
 * @method \Dew\Acs\Result getTrafficControlTaskTraffic(array $arguments = [])
 * @method \Http\Promise\Promise getTrafficControlTaskTrafficAsync($arguments = [])
 * @method \Dew\Acs\Result splitTrafficControlTarget(array $arguments = [])
 * @method \Http\Promise\Promise splitTrafficControlTargetAsync($arguments = [])
 */
