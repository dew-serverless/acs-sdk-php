 ...
 * @method \Http\Promise\Promise executeMigrationOperationAsync($arguments = [])
 * @method \Dew\Acs\Result finishMigrationStage(array $arguments = [])
 * @method \Http\Promise\Promise finishMigrationStageAsync($arguments = [])
 * @method \Dew\Acs\Result createDisasterRecoveryPlan(array $arguments = [])
 * @method \Http\Promise\Promise createDisasterRecoveryPlanAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result updateDisasterRecoveryPlan(array $arguments = [])
 * @method \Http\Promise\Promise updateDisasterRecoveryPlanAsync($arguments = [])
 * @method \Dew\Acs\Result listDisasterRecoveryPlans(array $arguments = [])
 * @method \Http\Promise\Promise listDisasterRecoveryPlansAsync($arguments = [])
 * @method \Dew\Acs\Result getDisasterRecoveryPlan(array $arguments = [])
 * @method \Http\Promise\Promise getDisasterRecoveryPlanAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result updateDisasterRecoveryItem(array $arguments = [])
 * @method \Http\Promise\Promise updateDisasterRecoveryItemAsync($arguments = [])
 * @method \Dew\Acs\Result deleteDisasterRecoveryItem(array $arguments = [])
 * @method \Http\Promise\Promise deleteDisasterRecoveryItemAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listDisasterRecoveryItems(array $arguments = [])
 * @method \Http\Promise\Promise listDisasterRecoveryItemsAsync($arguments = [])
 * @method \Dew\Acs\Result getDisasterRecoveryItem(array $arguments = [])
 * @method \Http\Promise\Promise getDisasterRecoveryItemAsync($arguments = [])
 * @method \Dew\Acs\Result listDisasterRecoveryCheckpoints(array $arguments = [])
 * @method \Http\Promise\Promise listDisasterRecoveryCheckpointsAsync($arguments = [])
 * @method \Dew\Acs\Result syncDisasterRecoveryCheckpoint(array $arguments = [])
 * @method \Http\Promise\Promise syncDisasterRecoveryCheckpointAsync($arguments = [])
