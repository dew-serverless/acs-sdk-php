 ...
 * @method \Dew\Acs\Result transformMatchToExpression(array $arguments = [])
 * @method \Http\Promise\Promise transformMatchToExpressionAsync($arguments = [])
 * @method \Dew\Acs\Result transformExpressionToMatch(array $arguments = [])
 * @method \Http\Promise\Promise transformExpressionToMatchAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result describeIPRangeList(array $arguments = [])
 * @method \Http\Promise\Promise describeIPRangeListAsync($arguments = [])
