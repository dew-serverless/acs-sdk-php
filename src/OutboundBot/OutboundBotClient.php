 ...
 * @method \Dew\Acs\Result deleteAgentProfiles(array $arguments = [])
 * @method \Http\Promise\Promise deleteAgentProfilesAsync($arguments = [])
 * @method \Dew\Acs\Result getAgentProfile(array $arguments = [])
 * @method \Http\Promise\Promise getAgentProfileAsync($arguments = [])
 * @method \Dew\Acs\Result listAgentProfiles(array $arguments = [])
 * @method \Http\Promise\Promise listAgentProfilesAsync($arguments = [])
 * @method \Dew\Acs\Result listApiPlugins(array $arguments = [])
 * @method \Http\Promise\Promise listApiPluginsAsync($arguments = [])
 * @method \Dew\Acs\Result createAgentProfile(array $arguments = [])
 * @method \Http\Promise\Promise createAgentProfileAsync($arguments = [])
 * @method \Dew\Acs\Result modifyAgentProfile(array $arguments = [])
 ...
 * @method \Dew\Acs\Result listIntentions(array $arguments = [])
 * @method \Http\Promise\Promise listIntentionsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listBeebotIntent(array $arguments = [])
 * @method \Http\Promise\Promise listBeebotIntentAsync($arguments = [])
 * @method \Dew\Acs\Result createBeebotIntent(array $arguments = [])
 * @method \Http\Promise\Promise createBeebotIntentAsync($arguments = [])
 * @method \Dew\Acs\Result describeBeebotIntent(array $arguments = [])
 * @method \Http\Promise\Promise describeBeebotIntentAsync($arguments = [])
 * @method \Dew\Acs\Result modifyBeebotIntent(array $arguments = [])
 * @method \Http\Promise\Promise modifyBeebotIntentAsync($arguments = [])
 * @method \Dew\Acs\Result deleteBeebotIntent(array $arguments = [])
 * @method \Http\Promise\Promise deleteBeebotIntentAsync($arguments = [])
 * @method \Dew\Acs\Result createBeebotIntentUserSay(array $arguments = [])
 * @method \Http\Promise\Promise createBeebotIntentUserSayAsync($arguments = [])
 * @method \Dew\Acs\Result listBeebotIntentUserSay(array $arguments = [])
 * @method \Http\Promise\Promise listBeebotIntentUserSayAsync($arguments = [])
 * @method \Dew\Acs\Result modifyBeebotIntentUserSay(array $arguments = [])
 * @method \Http\Promise\Promise modifyBeebotIntentUserSayAsync($arguments = [])
 * @method \Dew\Acs\Result deleteBeebotIntentUserSay(array $arguments = [])
 * @method \Http\Promise\Promise deleteBeebotIntentUserSayAsync($arguments = [])
 * @method \Dew\Acs\Result createBeebotIntentLgf(array $arguments = [])
 * @method \Http\Promise\Promise createBeebotIntentLgfAsync($arguments = [])
 * @method \Dew\Acs\Result listBeebotIntentLgf(array $arguments = [])
 * @method \Http\Promise\Promise listBeebotIntentLgfAsync($arguments = [])
 * @method \Dew\Acs\Result modifyBeebotIntentLgf(array $arguments = [])
 * @method \Http\Promise\Promise modifyBeebotIntentLgfAsync($arguments = [])
 * @method \Dew\Acs\Result deleteBeebotIntentLgf(array $arguments = [])
 * @method \Http\Promise\Promise deleteBeebotIntentLgfAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getJobDataUploadParams(array $arguments = [])
 * @method \Http\Promise\Promise getJobDataUploadParamsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getRealtimeConcurrencyReport(array $arguments = [])
 * @method \Http\Promise\Promise getRealtimeConcurrencyReportAsync($arguments = [])
 * @method \Dew\Acs\Result getBaseStrategyPeriod(array $arguments = [])
 * @method \Http\Promise\Promise getBaseStrategyPeriodAsync($arguments = [])
 * @method \Dew\Acs\Result getContactBlockList(array $arguments = [])
 * @method \Http\Promise\Promise getContactBlockListAsync($arguments = [])
 * @method \Dew\Acs\Result getContactWhiteList(array $arguments = [])
 * @method \Http\Promise\Promise getContactWhiteListAsync($arguments = [])
 * @method \Dew\Acs\Result getMaxAttemptsPerDay(array $arguments = [])
 * @method \Http\Promise\Promise getMaxAttemptsPerDayAsync($arguments = [])
 * @method \Dew\Acs\Result getEmptyNumberNoMoreCallsInfo(array $arguments = [])
 * @method \Http\Promise\Promise getEmptyNumberNoMoreCallsInfoAsync($arguments = [])
 * @method \Dew\Acs\Result getSummaryInfo(array $arguments = [])
 * @method \Http\Promise\Promise getSummaryInfoAsync($arguments = [])
 * @method \Dew\Acs\Result getVersion(array $arguments = [])
