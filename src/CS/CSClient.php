 ...
 * @method \Dew\Acs\Result startWorkflow(array $arguments = []) {@deprecated 2015-12-15}
 * @method \Http\Promise\Promise startWorkflowAsync($arguments = []) {@deprecated 2015-12-15}
 * @method \Dew\Acs\Result removeWorkflow(array $arguments = []) {@deprecated 2015-12-15}
 * @method \Http\Promise\Promise removeWorkflowAsync($arguments = []) {@deprecated 2015-12-15}
 * @method \Dew\Acs\Result cancelWorkflow(array $arguments = []) {@deprecated 2015-12-15}
 * @method \Http\Promise\Promise cancelWorkflowAsync($arguments = []) {@deprecated 2015-12-15}
 * @method \Dew\Acs\Result descirbeWorkflow(array $arguments = []) {@deprecated 2015-12-15}
 * @method \Http\Promise\Promise descirbeWorkflowAsync($arguments = []) {@deprecated 2015-12-15}
 * @method \Dew\Acs\Result describeWorkflows(array $arguments = []) {@deprecated 2015-12-15}
 * @method \Http\Promise\Promise describeWorkflowsAsync($arguments = []) {@deprecated 2015-12-15}
