 ...
 * @method \Dew\Acs\Result listElasticsearchIngestions(array $arguments = [])
 * @method \Http\Promise\Promise listElasticsearchIngestionsAsync($arguments = [])
 * @method \Dew\Acs\Result getElasticsearchIngestion(array $arguments = [])
 * @method \Http\Promise\Promise getElasticsearchIngestionAsync($arguments = [])
 * @method \Dew\Acs\Result deleteElasticsearchIngestion(array $arguments = [])
 * @method \Http\Promise\Promise deleteElasticsearchIngestionAsync($arguments = [])
 * @method \Dew\Acs\Result createElasticsearchIngestion(array $arguments = [])
 * @method \Http\Promise\Promise createElasticsearchIngestionAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result putIngestProcessor(array $arguments = [])
 * @method \Http\Promise\Promise putIngestProcessorAsync($arguments = [])
 * @method \Dew\Acs\Result getIngestProcessor(array $arguments = [])
 * @method \Http\Promise\Promise getIngestProcessorAsync($arguments = [])
 * @method \Dew\Acs\Result listIngestProcessors(array $arguments = [])
 * @method \Http\Promise\Promise listIngestProcessorsAsync($arguments = [])
 * @method \Dew\Acs\Result deleteIngestProcessor(array $arguments = [])
 * @method \Http\Promise\Promise deleteIngestProcessorAsync($arguments = [])
 * @method \Dew\Acs\Result updateLogStoreProcessor(array $arguments = [])
 * @method \Http\Promise\Promise updateLogStoreProcessorAsync($arguments = [])
 * @method \Dew\Acs\Result updateMetricStoreProcessor(array $arguments = [])
 * @method \Http\Promise\Promise updateMetricStoreProcessorAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result listAiTools(array $arguments = [])
 * @method \Http\Promise\Promise listAiToolsAsync($arguments = [])
 * @method \Dew\Acs\Result callAiTools(array $arguments = [])
 * @method \Http\Promise\Promise callAiToolsAsync($arguments = [])
 ...
 * @method \Dew\Acs\Result getMaxComputeExport(array $arguments = [])
 * @method \Http\Promise\Promise getMaxComputeExportAsync($arguments = [])
 * @method \Dew\Acs\Result createMaxComputeExport(array $arguments = [])
 * @method \Http\Promise\Promise createMaxComputeExportAsync($arguments = [])
 * @method \Dew\Acs\Result deleteMaxComputeExport(array $arguments = [])
 * @method \Http\Promise\Promise deleteMaxComputeExportAsync($arguments = [])
 * @method \Dew\Acs\Result listMaxComputeExports(array $arguments = [])
 * @method \Http\Promise\Promise listMaxComputeExportsAsync($arguments = [])
 * @method \Dew\Acs\Result startMaxComputeExport(array $arguments = [])
 * @method \Http\Promise\Promise startMaxComputeExportAsync($arguments = [])
 * @method \Dew\Acs\Result stopMaxComputeExport(array $arguments = [])
 ...
 * @method \Dew\Acs\Result startElasticsearchIngestion(array $arguments = [])
 * @method \Http\Promise\Promise startElasticsearchIngestionAsync($arguments = [])
 * @method \Dew\Acs\Result stopElasticsearchIngestion(array $arguments = [])
 * @method \Http\Promise\Promise stopElasticsearchIngestionAsync($arguments = [])
 * @method \Dew\Acs\Result updateElasticsearchInestion(array $arguments = [])
 * @method \Http\Promise\Promise updateElasticsearchInestionAsync($arguments = [])
 * @method \Dew\Acs\Result updateElasticsearchIngestion(array $arguments = [])
 * @method \Http\Promise\Promise updateElasticsearchIngestionAsync($arguments = [])
 */
